(function registerReadingExamData(global) {
  ...
  global.__READING_EXAM_DATA__.register("p1-low-53", {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q10-11-12-13-anchor\">\n                <h4>Complete the notes below.</h4>\n                <p>Write <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                <div class=\"notes-completion\">\n                    <h4 style=\"text-align: left;\">Amurca</h4>\n                    <p>In ancient times, this waste liquid was usually thrown away, which led to <strong>10</strong><input type=\"text\" id=\"q10_input\" name=\"q10\">.</p>\n                    <p>However, Romans had practical applications for amurca:</p>\n                    <ul>\n                        <li>• when dried, created a hard surface, so used on <strong>11</strong><input type=\"text\" id=\"q11_input\" name=\"q11\"> of certain buildings</li>\n                        <li>• used when making <strong>12</strong><input type=\"text\" id=\"q12_input\" name=\"q12\"></li>\n                        <li>• fed to livestock</li>\n                        <li>• used on farms as a <strong>13</strong><input type=\"text\" id=\"q13_input\" name=\"q13\"> to stop insects or animals from damaging crops</li>\n                    </ul>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "TRUE",
  ...
  "audit": {
    "matchStatus": "matched",
    "matchConfidence": 1,
    "verifiedAt": "2026-03-08T16:24:30.601Z",
