(function(g){'use strict';g.__READING_EXAM_DATA__.register("p3-high-218",{
  ...
  "questionGroups": [
    {
      ...
      "bodyHtml": "<div class=\"group\">\n      <h4>Questions 27-30</h4>\n      <p>Complete the summary below.</p>\n      <p><em>Choose NO MORE THAN THREE WORDS from the passage for each answer.</em></p>\n      <p>It is known that the pronunciation of language changes over time. The changes include large-scale regularities known as \n      <a id=\"q1-anchor\"></a><input type=\"text\" class=\"blank\" name=\"q1\" placeholder=\"27\">. There are several possible causes for change. Firstly, there is the effect of one language on another. Secondly, there is the role of \n      <a id=\"q2-anchor\"></a><input type=\"text\" class=\"blank\" name=\"q2\" placeholder=\"28\">. The speech of certain groups has prestige, and is imitated by others. It has also been suggested that some changes are introduced by \n      <a id=\"q3-anchor\"></a><input type=\"text\" class=\"blank\" name=\"q3\" placeholder=\"29\">, who are unable to imitate speech in an exact way. Finally, there is a factor referred to as the \n      <a id=\"q4-anchor\"></a><input type=\"text\" class=\"blank\" name=\"q4\" placeholder=\"30\">, by which the effort necessary to produce words is reduced.</p>\n    </div>"
    },
    {
      "groupId": "group-2",
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\">\n      <h4>Questions 38-40</h4>\n      <p>Look at the following statements (questions 38-40) and the list of options below.</p>\n      <p><em>Match each statement with the option A, B, C or D. Drag the correct option to the box below each statement.</em></p>\n\n      <!-- Draggable Options -->\n      <div class=\"cardpool pool-vertical\" id=\"pool-endings\">\n        <div class=\"card\" draggable=\"true\" id=\"c-a\" data-value=\"A\"><strong>A</strong> large-scale change</div>\n        <div class=\"card\" draggable=\"true\" id=\"c-b\" data-value=\"B\"><strong>B</strong> influence of one language on another</div>\n        <div class=\"card\" draggable=\"true\" id=\"c-c\" data-value=\"C\"><strong>C</strong> minimisation of effort</div>\n        <div class=\"card\" draggable=\"true\" id=\"c-d\" data-value=\"D\"><strong>D</strong> imitation of prestigious group</div>\n      </div>\n\n      <hr style=\"border:0; border-top:1px dashed var(--line); margin:20px 0;\">\n\n      <div>\n        <p><a id=\"q12-anchor\"></a><strong>38</strong> the b sound changing to a p sound at the end of words</p>\n        <span class=\"dropzone match-dropzone\" data-target=\"q12\" data-question=\"q12\"></span>\n      </div>\n      <div>\n        <p><a id=\"q13-anchor\"></a><strong>39</strong> the melodic pronunciation of Welsh English</p>\n        <span class=\"dropzone match-dropzone\" data-target=\"q13\" data-question=\"q13\"></span>\n      </div>\n      <div>\n        <p><a id=\"q14-anchor\"></a><strong>40</strong> the disappearance of the t sound in Christmas</p>\n        <span class=\"dropzone match-dropzone\" data-target=\"q14\" data-question=\"q14\"></span>\n      </div>\n    </div>"
    }
  ],
  "answerKey": {
    "q1": "sound laws",
