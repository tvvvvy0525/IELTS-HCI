(function registerReadingExplanationData(global) {
  ...
  global.__READING_EXPLANATION_DATA__.register("p3-low-43", {
  ...
  "passageNotes": [
    {
      "label": "第一段",
      "text": "自从历史学被提升到一门学科学术地位以来，它在很大程度上一直关注于自身制造的问题。这些问题可能是年轻研究者被导师建议去填补的空白；或者是他或她被鼓励去挑战的既定观点。在这两种情况下，研究者为了获得职业发展而提供新见解的需求，往往比主题本身的内在趣味更为重要。"
    },
    {
      "label": "第二段",
      "text": "社会史则截然不同。它触及并可以说有助于聚焦公众辩论的主要议题。它能激发大众的热情并引起大众的共鸣。它自豪于关注日常琐事而非轰动事件，并旨在反对最初定义历史的“伟人”理论，以及随后在20世纪20和30年代占据主导的对官僚问题的乏味关注。这一点也反映在其教学方式上，即采用多学科视角，而非狭隘的历史解释。"
    },
    {
      "label": "第三段",
      "text": "社会史，作为一种大众热情和一种学术实践，都源于20世纪60年代北美和欧洲的文化大革命，并再现了其主要的灵感来源。社会史的精神主要是现代化的，这体现在其主题的选择上。传统历史学关注的是12至17世纪，而社会史则倾向于将其历史腹地定在19世纪。近来，它甚至开始将其探究延伸至当代的事件和运动。"
    },
    {
      "label": "第四段",
      "text": "新社会史所青睐的主题，及其从贵族和权势阶层转移开的关注点，与20世纪60年代的其他文化表现形式相对应，例如以工人阶级为主角的英国新浪潮电影，或使用日常手工艺品的“波普艺术”。同样，新社会史的反体制偏见——即重新决心书写“普通人”的历史，而不是国家治理史——可以说呼应了一种更为广泛的社会尊卑秩序的崩溃，以及对各种权威人物的质疑。"
    },
    {
      "label": "第五段",
      "text": "20世纪60年代对新社会史的另一个主要影响——其起源和效果非常不同——是“怀旧产业”，它专注于销售近代历史的纪念品和手工艺品。这作为那个十年在其他方面占主导地位的现代化的一种消极对应物而出现，并反映了一种对战后社会变革的幻灭感，这种幻灭感在政治光谱的左翼和右翼同样明显。"
    },
    {
      "label": "第六段",
      "text": "工业考古学是20世纪60年代的一项发明，它将被废弃的工厂和磨坊提升到国家纪念碑的地位。沿着同样的轨迹，房地产修复者将为19世纪工厂工人建造的房屋——曾经是贫困、拥挤和不健康的象征——变成了风景如画的住宅。在另一个领域，人们可以看到民间俱乐部的激增和工业民歌的发现，预示着新社会史的一个主要主题——劳动的尊严。"
    },
    {
      "label": "第七段",
      "text": "就历史著作而言，到了20世纪70年代，这种幻灭感已经具体化为一种对过去的理想化看法，助长了对正在消失的社区的怀旧情怀。“我们失去的世界”中已消失部分的恢复成为历史写作和研究的一个主要推动力。普通人的尊严可以说是这条历史探究与寻回路线的统一主题——一种对日常生活的颂扬，即使，或许尤其是当它涉及到艰辛和苦难时。"
    },
    {
      "label": "第八段",
      "text": "尽管其主题新颖，社会史却再现了其前辈们的许多典型偏见。社会史学家擅长于收集关于家庭手工艺品、预算、日常采购的细节，但有时证据被假定为不言自明，简单的“事实”再现掩盖了作为解释的不足。积累起来的事实可能没有为那些巨大的缺失，为文献记录沉默的许多领域留下概念空间。"
    },
    {
      "label": "第九段",
      "text": "社会史学家对其研究对象所表现出的宽容，以及建立“共情”——即用过去的价值观而非今天的价值观来看待过去——的愿望，也可以用来奉承我们的自尊，使历史成为一个我们可以在不付出巨大代价的情况下，展示我们广博的同情心和仁慈的领域。认识到我们与过去人们的亲缘关系，并追溯或发现他们与我们的相似之处，我们便沾沾自喜地相信，在内心深处我们都是可爱的；也许古怪甚至荒谬，但却心地善良、慷慨坦率。这种与过去的融合感因此可以作为一种舒适的选择，替代批判性意识和自我反省，让我们通过与过去不正当的联系来美化现在。"
    },
    {
      "label": "第十段",
      "text": "社会史若要实现其颠覆性潜力，需要更具颠覆性。若要颂扬共同的人性，并将过去与现在更紧密地联系在一起，就必须更加重视不安全感和紧急情况的影响——那些笼罩着孩子成长的恐惧，我们在生活中遇到的对立——这些经历可能对个人难以归类，但其意义却超越了个体。"
    },
    {
      "label": "第十一段",
      "text": "或许我们也应该认识到，“普通人”这个概念中存在着一种深刻的居高临下——社会史学家倾向于将其作为一个统一的整体来处理。这个范畴我们往往将自己排除在外，尽管事实上我们只是因为拥有后见之明的特权才显得与众不同。“没有大众，”雷蒙德·威廉姆斯写道，“只有将人视为大众的方式。”也许现在是历史学家以同样的方式审视“普通人”这个词的时候了。"
    }
  ],
  "questionExplanations": [
    {
      "sectionTitle": "1. 概要填空（Questions 27–31）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 27,
    ...
    {
      "sectionTitle": "3. 单选题（Questions 36–40）",
      "mode": "per_question",
      "items": [
        {
          "questionNumber": 36,
