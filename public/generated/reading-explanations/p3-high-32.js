(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "第一段",
      "text": "每年，美国的电影学院都会在一个名为奥斯卡奖的典礼上，表彰该年度的杰出成就。这个典礼中一个日益重要的组成部分是科学技术奖的颁发。2004年发生了一件引人注目的事：当来自美国斯坦福大学的研究人员被授予奥斯卡奖时，学术界与电影界相遇了。这些由史蒂夫·马什纳领导的研究人员，来自斯坦福大学的计算机图形学领域。他们属于一个不断壮大的计算机科学家群体，这个群体已成为电影制作的基础。"
    },
    {
      "label": "第二段",
      "text": "电影已经证明，使用计算机生成图像（CGI）可以使演员看起来比实际更年轻、更年老、更虚弱或更强壮，并且效果惊人地逼真。至少，如果被改变的演员不是在特写镜头下拍摄，这是可能的。这是因为再现皮肤和织物的纹理很困难，意味着近看时效果不那么令人信服。马什纳及其同事的工作极大地改进了皮肤和织物的精确和逼真建模。他们认识到，在计算机世界中创造栩栩如生角色的困难之一是，在CGI中，角色的皮肤是不透明的（二维的），而真实的皮肤实际上是半透明的（三维的），也就是说，它是半透明的。"
    },
    {
      "label": "第三段",
      "text": "马什纳及其同事因成功制作出模拟半透明效果的CGI模型而获得奥斯卡奖；这种效果是指光线穿透皮肤，然后在皮肤表面下散射，最后再重新出现。这被称为次表面散射，该模型的数学原理可以追溯到几十年前，当时它被用于天体物理学。因为人类皮肤天然是半透明的，所以必须能够人工创造出这种效果，以模拟真实皮肤的柔和外观。以前的CGI模型假设皮肤是完全不透明的，导致角色看起来有塑料感。科学家们的新CGI模型在赋予数字角色生命力方面非常重要，以至于在他们的原始研究论文发表后的两年内，所有主要的特效工作室都已将其纳入其数字渲染系统。"
    },
    {
      "label": "第四段",
      "text": "然而，尽管获得了奖项，这些科学家们以令人钦佩的坚韧精神，继续追求完美，因为他们仍然觉得尚未满意地再现光线被反射的微妙方式。为了做到这一点，他们开始详细研究皮肤和织物根据其构成不同而反射光线的不同方式：织物中纤维的精确排列方式和皮肤中的纤维网络。马什纳和他的团队试图通过使用计算机断层扫描来做到这一点，这是一种最为人熟知的用于检查人体内部器官的医疗技术。像传统放射学一样，它使用X射线，但因为图像是在计算机内部使用从许多不同位置拍摄的曝光构建的，而不是在照相胶片上进行单次曝光，所以它可以捕捉到传统放射摄影中看不见的精细细节。"
    },
    {
      "label": "第五段",
      "text": "不幸的是，科学家们明白，在目前这个时间点，他们不能在皮肤上使用计算机断层扫描，因为需要非常高强度的X射线才能显示他们想要的细节，而这对人类皮肤会非常危险。然而，他们在织物上取得了一些成功。使用这种新的成像方法，他们能够精确地记录下许多小块织物中所有纤维的三维结构。然后，通过使用CGI，这些相同的织物片可以在计算机内部被拼凑在一起，形成一整件服装，就像一小群演员可以被弄得看起来像成百上千人聚集在一起一样。因此，通过CGI创建的服装是由其内部结构已被预先记录的织物片组成的。这意味着服装反射光线的方式可以被计算得比科学家仅仅制作一个他们想象中织物内部样子的计算机模型要真实得多。电影摄影将因此受益，因为虽然可能需要数年才能使用计算机断层扫描成像皮肤，但就目前而言，虚拟斗篷的运动或计算机生成的帽子的掀起应该会看起来真实得多。"
    },
    {
      "label": "第六段",
      "text": "与此同时，根据马什纳的同事卡维塔·巴拉的说法，这项技术可能在网络零售中有应用。目前，在网上购买衣服的人只有一张标准的照片来帮助他们选择购买。人们希望，如果在线购物者可以查看通过使用计算机断层扫描图形呈现的商品，他们将对自己所购商品是由什么材料制成的有更好的了解。"
    },
    {
      "label": "第七段",
      "text": "马什纳现在正在研究光线从单根头发上散射的方式。他说：“我感到很幸运能在这个领域工作。我是一个视觉型的人，能够花时间仔细审视我周围的世界，试图理解它为什么看起来是这个样子，这是非常有益的。”"
    }
  ],
  "questionExplanations": [
    {
      "sectionTitle": "1. 选择题（Questions 27–32）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 27,
    ...
    {
      "sectionTitle": "2. 判断题（Questions 33–36）",
      "mode": "per_question",
      "items": [
        {
          "questionNumber": 33,
    ...
    {
      "sectionTitle": "3. 概要填空（Questions 37–40）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 37,
