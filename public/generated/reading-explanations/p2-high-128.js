(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "边听音乐边阅读、边看电视边写作业的人被称为 “多任务处理者”，他们通过分配注意力同时完成两项任务。但心理学家托马斯・莱曼（Thomas Lehman）认为，人类无法真正同时处理多项任务 —— 看似边听音乐边阅读，实则大脑每次仅聚焦一项任务（阅读会让人忽略部分音乐内容）。当人们认为自己高效完成双任务时，实际是在 “分配注意力”。例如，与人交谈时对方因看手机未认真回应，莱曼将这种 “专注于屏幕而忽略周围” 的现象称为 “邮件式走神（email voice）”。"
    },
    {
      "label": "Paragraph B",
      "text": "电脑及智能手机等衍生设备改变了世界，个人设备的普及使人们频繁接触虚拟信息，多任务行为在日常生活中愈发普遍。如今工作时可能同时使用打字机、手机，还需应对同事随时到访；商务会议中，人们不再专注交流，常低头看手机；无绳电话等发明也加剧了多任务 —— 过去固定电话响起时，家庭主妇需停下所有家务接电话，如今便捷技术不再打断日常活动。"
    },
    {
      "label": "Paragraph C",
      "text": "麻省理工学院专家厄尔・米勒（Earl Miller）研究了负责多任务时大脑引导功能的前额叶皮层（prefrontal cortex），发现不同物种该皮层占比不同（人类占 1/3，狗占 4%-5%，猴子占 15%），人类该皮层更大，理论上多任务灵活性和准确性更强。但米勒通过实验（给受试者呈现模拟多任务的视觉刺激，用传感器监测脑电活动）发现，大脑神经元每次仅在单一区域活跃，从未同时处理两项任务。"
    },
    {
      "label": "Paragraph D",
      "text": "密歇根大学教授戴维・迈耶（David Meyer）对年轻人的实验也得出类似结论：他让受试者边解数学题边给单词分类，发现所谓 “同时完成双任务” 实际是 “任务切换”。尽管最终两项任务均完成，但总耗时比专注单任务更长。"
    },
    {
      "label": "Paragraph E",
      "text": "格洛丽亚・马克（Gloria Mark）以办公室职员为研究对象，发现他们频繁多任务，平均每 11 分钟被干扰一次（包括自我干扰和外部干扰）。虽然多任务看似节省时间，但效率并未提升 —— 职员每 12 分钟会无理由刷网页、打电话或写邮件，专注超过 20 分钟就会感到焦虑，这可能源于人类天生注意力持续时间短，也可能是手机、电脑等技术及短视频、广告等短格式媒体让人习惯短时专注。"
    },
    {
      "label": "Paragraph F",
      "text": "尽管专注单任务是大脑最高效的工作方式，但现实中未必可行 —— 人类天性更适应多任务环境。爱德华・哈洛威尔（Edward Hallowell）指出，多任务、外部干扰和自我干扰导致职场效率大幅下降，但改善无需剧烈变革（无需禁止邮件或强制单任务）。例如会议中禁用手机可提升效率；个人也可通过 “早晨先专注 1 小时单任务”“自我计时逐一完成任务” 等方法减少干扰，避免多任务拖慢进度。"
    }
  ],
  "questionExplanations": [
    {
      "sectionTitle": "1. 段落匹配（Questions 14–18：Which paragraph contains the following information?）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 14,
    ...
    {
      "sectionTitle": "2. 科学家 - 观点匹配（Questions 19–23：Match each statement with the correct scientist）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 19,
    ...
    },
    {
      ...
      "text": "题目翻译：用于描述 “阅读文本时无法专注于周围” 的术语是_\\___\\___\\_。\n答案：email voice（邮件式走神）\n解析：定位 Paragraph A 中 “we all have experienced times when we talk with friends and they are not responding properly... maybe they are reading a text on their smartphone... Lehman called this phenomenon ‘email voice’”，明确提到该术语为 “email voice”，因此答案为 “email voice”。\n题目翻译：大脑的_\\___\\___\\_部位控制多任务处理。\n答案：prefrontal cortex（前额叶皮层）\n解析：定位 Paragraph C 中 “Earl Miller... studied the prefrontal cortex, which guides the brain while a person is multitasking”，明确提到 “前额叶皮层” 控制多任务，因此答案为 “prefrontal cortex”。\n题目翻译：职场多任务的可行解决方案是在_\\___\\___\\_中禁止使用手机。\n答案：group meetings（小组会议）\n解析：定位 Paragraph F 中 “certain common workplace situations-such as group meetings-would be more efficient if we banned cellphones”，明确提到 “会议中禁用手机”，因此答案为 “group meetings”。"
    }
  ]
}
  );
