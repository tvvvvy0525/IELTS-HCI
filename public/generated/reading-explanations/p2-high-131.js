(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "为研发更耐用、可持续的混凝土，国际地质与工程团队从古代罗马混凝土中汲取灵感。通过分析罗马防波堤（保护海岸港口免受海浪冲击的屏障）样本（该防波堤已在海水中浸泡 2000 年），团队揭开了罗马混凝土的化学秘密。加州大学伯克利分校的保罗・蒙泰罗（Paulo Monteiro）教授带领团队，对意大利那不勒斯附近波佐利湾的水下样本分析后，明确了优质罗马混凝土优于多数现代混凝土的原因。"
    },
    {
      "label": "Paragraph B",
      "text": "混凝土是罗马帝国的首选建筑材料，既用于罗马万神殿等陆地建筑，也用于水下海岸港口结构。蒙泰罗团队特别关注海岸结构为何能耐受严苛海水环境 —— 化学分析显示，罗马混凝土与现代混凝土的关键差异在于胶凝材料（cement）：现代常用波特兰水泥（Portland cement）由钙、硅酸盐和水合物（C-S-H）构成，而罗马水泥含铝（波特兰水泥无）且硅含量更低，形成的钙铝硅水合物（C-A-S-H）稳定性极高。"
    },
    {
      "label": "Paragraph C",
      "text": "公元前 30 年左右，罗马皇帝奥古斯都的工程师维特鲁威（Vitruvius）首次记载罗马混凝土配方，其中火山灰是关键成分（含铝，最终赋予混凝土高耐久性）。罗马人制作海岸混凝土的高效方法是：将火山灰与石灰（提供钙）混合，与石头、岩块一同填入木模，再浸入海水。海水立即触发放热化学反应 —— 石灰水化（结构中融入水分子），与火山灰反应使混合物固结，这种混凝土建造了西方文明中最耐久的部分建筑。"
    },
    {
      "label": "Paragraph D",
      "text": "团队成员玛丽・杰克逊（Marie Jackson）指出，罗马混凝土是全球最耐久的建筑材料之一，这并非偶然 —— 航运是罗马帝国政治、经济和军事稳定的生命线，建造耐用港口至关重要。她解释：“随着罗马帝国衰落、航运减少，海水混凝土需求下降”，且 “原有建筑过于耐用，无需更换”。"
    },
    {
      "label": "Paragraph E",
      "text": "罗马混凝土的碳足迹也小于现代混凝土 —— 蒙泰罗指出：“现代混凝土并非不好，年产量达 190 亿吨，但波特兰水泥生产占工业二氧化碳排放量的 7%”。波特兰水泥需将石灰石与黏土混合物加热至 1450℃（燃烧燃料释放二氧化碳），而罗马混凝土生产无需高温，所需温度仅为波特兰水泥的 2/3，更为环保。"
    },
    {
      "label": "Paragraph F",
      "text": "现代部分混凝土用粉煤灰（fly ash，燃煤废料，温室气体排放更少）替代波特兰水泥，但研究团队发现粉煤灰资源有限（无法替代一半波特兰水泥），且许多国家难以获取，因此探索火山灰等本地替代材料（如罗马人使用的类型），有望替代全球 40% 的波特兰水泥需求。"
    },
    {
      "label": "Paragraph G",
      "text": "减少温室气体排放和建造更坚固耐久的建筑，是研发新型混凝土的两大动力 ——20 世纪中期混凝土设计寿命为 50 年（多数已超期），如今设计寿命为 100-120 年，而罗马港口结构已在海水侵蚀下存续 2000 年。对罗马混凝土的深入理解，或将为现代混凝土带来 “更坚固、更耐久” 的传承。"
    }
  ],
  "questionExplanations": [
    ...
    },
    {
      ...
      "text": "题目：According to the passage, which TWO of the following statements about fly ash are true?（根据文章，关于粉煤灰的哪两项表述正确？）\n答案：A、C\n选项 A：Fly ash results in less damage to the environment than Portland cement.（粉煤灰对环境的破坏小于波特兰水泥）\n解析：定位 Paragraph F 中 “fly ash is used, which causes fewer greenhouse gas emissions”，“更少温室气体排放” 即 “环境破坏更小”，A 正确。\n- 选项 C：Fly ash is already used in the production of some concrete.（粉煤灰已用于部分混凝土生产）\n解析：定位 Paragraph F 中 “Some modern concrete no longer contains Portland cement; instead, fly ash is used”，明确提到部分混凝土用粉煤灰，C 正确。\n- 排除 B：罗马人用火山灰，非粉煤灰，B 错误；排除 D：Paragraph F 提到 “Many countries don’t have fly ash”，D 错误；排除 E：文中无 “粉煤灰取代火山灰” 的表述，E 错误。"
    },
    {
      "sectionTitle": "3. 摘要填空（Questions 23–26：ONE WORD AND/OR A NUMBER）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 23,
      ...
      "text": "题目翻译：这是因为制作波特兰水泥需将黏土与_\\___\\___\\_混合，并加热至 1450℃。\n答案：limestone（石灰石）\n解析：定位 Paragraph E 中 “heating a mix of limestone and clays to 1,450 degrees Celsius”，明确提到混合材料为 “石灰石与黏土”，因此答案为 “limestone”。\n题目翻译：制作罗马混凝土时，所需温度降低了_\\___\\___\\_。\n答案：third（三分之一）\n解析：定位 Paragraph E 中 “A temperature that was a third lower than that required for making Portland cement was sufficient for making Roman concrete”，明确提到温度降低 “三分之一”，因此答案为 “third”。\n题目翻译：所需热量减少意味着需燃烧的_\\___\\___\\_更少，产生的二氧化碳也更少。\n答案：fuel（燃料）\n解析：定位 Paragraph E 中 “making Portland cement releases carbon dioxide into the atmosphere from burning fuel”，明确提到燃烧 “燃料” 产生二氧化碳，热量减少则燃料消耗减少，因此答案为 “fuel”。\n题目翻译：蒙泰罗指出，在_\\___\\___\\_排放的二氧化碳中，7% 来自波特兰水泥生产。\n答案：industry（工业）\n解析：定位 Paragraph E 中 “manufacturing Portland cement accounts for seven percent of the carbon dioxide that industry puts into the air”，明确提到 “工业排放的二氧化碳”，因此答案为 “industry”。"
    }
  ]
}
  );
