(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "1877 年，意大利天文学家乔瓦尼・斯基亚帕雷利（Giovanni Schiaparelli）绘制的火星表面图显示出奇特特征，因当时望远镜分辨率有限，他称看到 “运河网络（canali）”。1894 年，美国天文学家珀西瓦尔・洛厄尔（Percival Lowell）在亚利桑那州弗拉格斯塔夫天文台观测火星，坚信 “火星人挖掘了庞大运河网络灌溉作物”，认为运河两侧有肥沃植被（从地球可见），其绘制的地图和地球仪显示火星遍布运河与绿洲。"
    },
    {
      "label": "Paragraph B",
      "text": "19 世纪末，“火星存在智慧生命” 的观点逐渐流行：1898 年，H.G. 威尔斯（H.G. Wells）创作科幻经典《世界大战》，讲述火星人入侵地球（使用当时先进技术压制人类）；1917 年，埃德加・赖斯・巴勒斯（Edgar Rice Burroughs）出版首部火星系列小说，奇特生物与狂暴火星怪物引发公众想象；1938 年万圣节，奥森・威尔斯（Orson Welles）广播《世界大战》，引发美国大范围恐慌，数百万人误以为火星人真的入侵。"
    },
    {
      "label": "Paragraph C",
      "text": "探测器对了解其他行星至关重要，近期关于火星的知识多来自这些无人太空任务：1965 年 7 月，“水手 4 号（Mariner 4）” 传回首张火星照片，显示其表面布满陨石坑、荒芜（更像月球而非地球）；1969 年，“水手 6 号” 和 “7 号” 飞掠火星，拍摄 200 张南半球与极地照片，但未新增太多信息；1971 年，“水手 9 号” 成为首个环绕火星的探测器（每 12 小时一圈）；1975 年，美国发射两个 “海盗号（Viking）” 探测器（各含轨道器与着陆器），着陆器用机械臂采集火星岩石，开展生命探测实验（未发现生命），但传回首张火星表面与大气的彩色照片。"
    },
    {
      "label": "Paragraph D",
      "text": "地球上发现的火星陨石引发对上述结论的质疑 ——1984 年 12 月，ANSMET 项目成员在南极发现陨石 ALH 84001，该样品约 1700 万年前从火星弹出，在南极冰层中存在 1.1 万年。NASA 成分分析发现 “一种仅与特定微生物相关的磁铁矿”，部分结构类似地球细菌的矿化铸型，大小形状与地球纳米细菌化石一致，但纳米细菌的存在本身仍有争议。"
    },
    {
      "label": "Paragraph E",
      "text": "1965 年，“水手 4 号” 发现火星无全球磁场（无法抵御致命宇宙射线与太阳辐射），1990 年代末 “火星全球勘测者号” 证实这一发现。科学家推测，磁场缺失导致太阳风在数十亿年间吹走火星大部分大气。研究火星不同深度的宇宙辐射水平后，研究者认为 “表面数米内的生命会被致命辐射杀死”，2007 年测算显示 “DNA 与 RNA 损伤限制火星生命需存在于地表 7.5 米以下”，因此最佳生命探测地可能是未被研究的地下环境。磁场消失还可能导致火星气候剧变 —— 科学家评估，火星气候从 “温暖湿润” 逐渐转变为 “寒冷干燥”。"
    },
    {
      "label": "Paragraph F",
      "text": "NASA 近期任务聚焦 “火星古代是否存在液态湖泊或海洋”：科学家发现 “赤铁矿（仅在有水时形成）”，因此 2004 年 “火星探索漫游者号” 的设计目标是 “寻找古代液态水证据”（非当前或过去生命）。因火星当前大气压低、温度低，液态水无法在表面持久存在（仅在最低阴影海拔处短暂存在）。2004 年 3 月，NASA 宣布 “机遇号” 漫游者发现 “火星曾是湿润行星” 的证据，燃起找到过去生命痕迹的希望；同年 1 月，“火星快车号” 轨道器在火星南极发现大量水冰。"
    },
    {
      "label": "Paragraph G",
      "text": "西班牙天体生物学中心与智利北方天主教大学的研究者，在阿塔卡马沙漠地表下 2 米处发现 “微生物绿洲”，生命探测仪器 SOLID 可用于 “类似火星地下土壤的环境”。天体生物学中心的维克多・帕罗（Víctor Parro）解释：“我们称之为微生物绿洲，因发现微生物生长在富含岩盐和其他高吸湿性化合物的栖息地中（这些化合物吸收水分）。若火星类似环境中存在类似微生物或其遗迹，可用 SOLID 等仪器探测。”"
    },
    {
      "label": "Paragraph H",
      "text": "西班牙科学家提出更有趣的假设：若火星样品也含 DNA（与地球生命一致），这种复杂分子不可能在两颗行星上独立进化，意味着 “火星与地球生命同源”—— 可能 DNA 生命先出现在火星，再传播到地球，进化为如今的多样生物。若成立，人类将面临惊人结论：“我们都是火星人”；若不成立，则需继续寻找其他生命迹象。"
    }
  ],
  "questionExplanations": [
    {
      "sectionTitle": "1. 段落匹配（Questions 27–32：Which paragraph contains the following information?）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 27,
    ...
    {
      "sectionTitle": "2. 单选题（Questions 33–36：Choose A–D）",
      "mode": "per_question",
      "items": [
        {
          "questionNumber": 33,
      ...
      "text": "答案：C（There are clear traces of water and agriculture similar to Earth’s. 存在类似地球的水和农业痕迹）\n解析：定位 Paragraph A 中 “Lowell was convinced a great network of canals had been dug to irrigate crops for the Martian race. He suggested that each canal had fertile vegetation on either side”，“运河灌溉作物、两侧有植被” 对应 “水和农业痕迹”，因此选 C。A（亚利桑那州是最佳观测地）、B（火星运河比地球宽）、D（通过望远镜看到活动的火星生物）均未提及。\n答案：B（They absorbed new ideas through literary works. 通过文学作品吸收新观点）\n解析：定位 Paragraph B 中 “In 1898, H. G. Wells wrote... In 1917, Edgar Rice Burroughs wrote... Strange beings and rampaging Martian monsters gripped the public’s imagination”，“威尔斯、巴勒斯的文学作品塑造公众对火星的想象”，因此选 B。A（经历真实火星入侵）、C（通过著名广播节目学习新观点）（仅 1938 年单次事件，非 “19 世纪起” 的整体改变）、D（参加知名作家的公开讲座）均未提及。\n答案：B（It appeared far less dynamic than Earth. 看起来远不如地球有活力）\n解析：定位 Paragraph C 中 “The first images sent back from Mars came from Mariner 4 in July 1965. They showed a cratered and barren landscape, more like the surface of our Moon than Earth”，“布满陨石坑、荒芜（类似月球）” 对应 “less dynamic than Earth”，因此选 B。A（地表布满岩石和河流）、C（含与月球完全相同的物质）、D（图像与后续探测器完全不同）均与原文矛盾。\n答案：A（It could be employed to explore organisms under Martian-like conditions. 可用于在类似火星的条件下探索生物）\n解析：定位 Paragraph G 中 “‘If similar microbes, or their remains, exist on Mars under comparable conditions, we could detect them with instruments like SOLID,’ Parro added”，“SOLID 可用于火星类似环境的生命探测”，因此选 A。B（无法用于类似火星环境的生命识别）、C（阿塔卡马沙漠是地球唯一适合此类生物的地方）、D（未在阿塔卡马沙漠发现生命）均与原文矛盾。"
    },
    {
      "sectionTitle": "3. 判断题（Questions 37–40：TRUE/FALSE/NOT GIVEN）",
      "mode": "per_question",
      "items": [
        {
          "questionNumber": 37,
