(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "人类学家帕特里夏・尚利（Patricia Shanley）在亚马逊贫困人群允许她研究其土地与生态后，将研究成果改编成图画书《亚马逊人的果树与有用植物》（俗称 “果实之书”），指导当地人如何从树木中获得合理回报，避免被伐木公司的短期利益诱惑。该书大获成功，第二版应亚马逊西部政客请求出版，融合 35 种本土森林物种的实用科学知识与当地使用及贸易经验，广受好评，巴西环境部长玛丽娜・席尔瓦（Marina Silva）为其作序，亚马逊人与环境研究所所长称其 “将科学还给穷人”。"
    },
    {
      "label": "Paragraph B",
      "text": "尚利十年前受帕拉戈米纳斯农村工人工会（巴西帕拉州里奥卡皮姆河沿岸农民社区）请求开始撰写该书 —— 该工会意识到伐木公司即将接触当地农民（卡波克洛人，多文盲且孤立），而下游社区已低价出售大片森林，工会希望了解森林的真实价值，尚利当时作为伍兹霍尔研究中心研究员在该地区工作。"
    },
    {
      "label": "Paragraph C",
      "text": "工会想知道 “在里奥卡皮姆河地区采集野生果实是否经济可行”—— 当时环保组织和绿色企业推广 “非木材森林产品（NTFPs）贸易”，1989 年《自然》杂志论文《亚马逊雨林的价值评估》提出 “果实销售收入远超一次性出售树木给伐木公司的收入”，工会希望确认 “保护森林用于自给及可能出售果实、猎物和药用植物” 是否比出售木材更合理，但该模式对卡波克洛人是否可行尚不明确。"
    },
    {
      "label": "Paragraph D",
      "text": "尽管尚利获邀在里奥卡皮姆河工作，部分农民仍存疑虑（如农民曼格维拉起初被邻居告知尚利是 “掠夺树木的外国人”），但最终他参与研究。尚利通过研究农民的原始森林，识别出三种亚马逊广泛分布、农民偏爱的果树（巴库里树、乌西树、皮奎亚树）—— 农民使用其果实、提取油脂、了解其吸引的野生动物，但面对伐木公司的强势策略，他们不知树木的经济价值。尚利决定从零开始开展科学研究（当时这些树木的科学研究极少），六年野外研究收集了大量开花结果数据，1993-1994 年，30 户家庭称重并记录从森林获取的所有资源（猎物、果实、纤维、药用植物）及其来源。"
    },
    {
      "label": "Paragraph E",
      "text": "1997 年三次伐木销售和一场大火后，研究者还能观察生态系统对伐木和干扰的反应，1999 年对 15 户家庭开展类似研究（规模较小），发现变化显著：1993-1999 年，家庭年均森林果实消费量从 89 公斤降至 28 公斤，尚利指出 “果实采集可与少量伐木共存，但火灾后大幅减少”；同期纤维使用量从 20 公斤降至 4 公斤，火灾和伐木还改变饮食 ——1993 年多数家庭每月吃 2-3 次猎物，1999 年部分家庭每年仅吃 2-3 次。"
    },
    {
      "label": "Paragraph F",
      "text": "特定树种的消失影响显著 —— 尚利团队说服猎人称重猎物并记录捕获地点，一年间在皮奎亚树下捕获 5 种猎物（平均 232 公斤）， Copaiba 树下捕获 2 种（63 公斤），乌西树下捕获 4 种（38 公斤）。团队由此明确 “应保留和可出售的树木”，尚利解释 “将皮奎亚树低价卖给伐木公司不合理，其本地价值在于提供珍贵果实和吸引最多猎物的花朵”。"
    },
    {
      "label": "Paragraph G",
      "text": "研究结果显示，尚利需告知工会 “《自然》论文的理论不能完全适用于该社区”—— 非木材森林产品采集并非总能比出售木材收益更高（如乌西树结果模式不可预测，1994 年一户家庭采集 3654 个乌西果，次年为零）。"
    },
    {
      "label": "Paragraph H",
      "text": "但这并不意味着野生果树不重要 —— 尚利认为果树对 “自给自足” 至关重要，而当前非木材森林产品研究常忽视这一点，聚焦商业潜力；地理因素也阻碍当地农民开展野生果实贸易（偏远地区无法与靠近城市市场的社区竞争，仅能卖给过往河船）。"
    },
    {
      "label": "Paragraph I",
      "text": "尚利团队决定不仅向工会报告结果，还与同事合著 “果实之书”—— 该书与《圣经》、尚利合著的低识字率人群药用植物书是里奥卡皮姆河沿岸最常见的书籍。首版仅 3000 册，但影响力显著，被高校、农民工会、企业和农民使用，成功原因在于 “低识字率人群可通过插图、轶事、故事和歌曲理解非木材森林产品信息”。尚利强调 “该书不指令行动，而是提供选择”，使用该书的农民现在更清楚 “应卖给伐木公司和应保护的树木”。"
    }
  ],
  "questionExplanations": [
    ...
    {
      "sectionTitle": "2. 摘要填空（Questions 33–40：NO MORE THAN THREE WORDS）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 33,
