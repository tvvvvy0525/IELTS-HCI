(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "美洲最南端的人类定居一直令史前史学家着迷。从全球视角看，这是人类到达的最后一块主要大陆陆地。巴塔哥尼亚的最早占领对于理解北美和南美大陆何时有人类居住具有明显的意义，因为它提供了一个基线，所有关于人类在这两个大陆扩散速率的计算都必须将其考虑在内。"
    },
    {
      "label": "Paragraph B",
      "text": "多年来，北美和南美的人类定居一直被认为是始于遥远的北方，逐渐向南行进至巴塔哥尼亚。然而，关于所涉时间长度，出现了根本性的分歧。一些学者接受早在2万年前美洲就已有人类存在，而另一些学者则认为年代不可能早于8000年前。这场辩论至今仍在继续。"
    },
    {
      "label": "Paragraph C",
      "text": "关于美洲定居相对较晚（约8000年前）的观点意味着一个快速的迁徙过程。这就引出了第二个辩论，其核心是如何理解迁徙这个问题。较晚模型需要一个假想的迁徙过程：被设想为单一、持续推进的定居浪潮。这一观点一直难以被认真对待。许多学者现在支持较早模型，该模型认为迁徙是较为无序的过程，无疑是最现实的情景，因为迁徙者在穿越大陆时会慢慢适应他们遇到的多样化的自然栖息地。"
    },
    {
      "label": "Paragraph D",
      "text": "然而，那些主张更早定居的人，必须应对缺乏年代早于约14000年的明确考古遗址证据的问题。尽管如此，南美洲中部人类占领的证据已在蒙特维尔德遗址被确切地定年在约12500年前。这对较晚模型提出了质疑。这一时期更南边缺乏考古证据，可以用当时存在的巨大冰川溪流对步行的人类构成的障碍来解释。"
    },
    {
      "label": "Paragraph E",
      "text": "大约14000年前巴塔哥尼亚冰川的退缩，使得人类首次进入一个原始环境，这与早期后冰川时代的欧洲环境相似。在这片广阔无树的高原上的人类定居必定是极其脆弱的，而关于这次占领的证据仍然相对稀少，大部分来自阿根廷和智利的岩石庇护所。然而，有来自这些遗址的可靠证据证实，约11000年前人类已在不同栖息地存在。其他一些最初被认为有更早人类占领证据的遗址，最近受到了新的审查。这是因为人类学家已经认识到，骨头或其他证据可能是由自然力量如洪水或捕食者带入洞穴的，而不一定是由人类带入的。"
    },
    {
      "label": "Paragraph F",
      "text": "现在对巴塔哥尼亚各地的考古证据进行更详细的讨论。在钦奇瓦皮溪旁的遗址，发掘工作产生了令人信服的人类居住证据，包括小屋地基和木制手工艺品。它们被埋在泥炭层中，泥炭具有极好地保存木材的特性，放射性碳测年测试显示这些手工艺品的年代约为12500年前。巴塔哥尼亚最著名的遗址之一名为洛斯托尔多斯洞穴。然而，该遗址的证据最近受到了质疑，因为测试过程中使用的分散碳屑是从该遗址的许多不同地方非系统地采集的，与手工艺品的关联性完全不明确。向南约150公里处是埃尔塞博遗址，在挖掘的最低层发现了与洛斯托尔多斯相似的手工艺品，但至今没有放射性碳测年数据。"
    },
    {
      "label": "Paragraph G",
      "text": "阿罗约埃奥遗址的手工艺品与洛斯托尔多斯在相同深度被发现，且来源相同，被确切地定年在约9000年前。拉斯布伊特雷拉斯遗址发现了许多与动物骨骼遗骸相关的石片。然而，人类学家现在认为骨骼上推定的切割痕迹有些可疑。尽管经过详细测试，仍无法将这些遗骸与人类居住确切地联系起来。最后，向南约50公里处是奎瓦费尔遗址，这是第一个由现代考古方法系统研究的巴塔哥尼亚遗址。然而，鉴于附近地区因洪水引起的变化，该遗址的用途必须限于其直接周边地区，其发现不能自由地外推到更远的地方。"
    },
    {
      "label": "Paragraph H",
      "text": "总之，基于来自多个可靠遗址的证据，人类群体似乎很可能在约11000年前到达了巴塔哥尼亚。"
    }
  ],
  "questionExplanations": [
    {
      "sectionTitle": "1. 单选题（Questions 27-31）",
      "mode": "per_question",
      "items": [
        {
          "questionNumber": 27,
      ...
      "text": "答案：C (It impacts on research into the wider region.)\n解析：定位 Paragraph A。该段指出巴塔哥尼亚的最早占领为理解南北美洲大陆何时有人居住提供了明显意义，并给出一个基线来计算人类扩散速率。这表明巴塔哥尼亚的研究影响了对更广泛区域的人类迁徙研究。\n答案：C (to summarise a scholarly debate)\n解析：定位 Paragraph B。该段列举了两种对立的观点：一些人认为最早在2万年前，另一些人则认为不早于8000年前，并指出这场辩论至今仍在继续。作者的意图是总结这场学术辩论。\n答案：A (compare it with another theory of migration.)\n解析：定位 Paragraph C。先描述较晚模型设想为单一持续浪潮的迁徙过程，随后立即引入与之形成对比的较早模型，并指出后者更现实。因此目的是与另一迁徙理论进行比较。\n答案：D (It is more consistent with the physical conditions of the land.)\n解析：定位 Paragraph C。较早模型认为迁徙是较为无序的过程，因为迁徙者在穿越大陆时需要缓慢适应遇到的多样化自然栖息地。这更符合土地的实际物理状况，因此该模型更现实。\n答案：B (It provides supporting evidence for relatively early settlement.)\n解析：定位 Paragraph D。蒙特维尔德遗址的年代被确定为约12500年前，这对较晚模型提出了质疑，从而为相对较早的定居理论提供了支持证据。"
    },
    {
      "sectionTitle": "2. 判断题（Questions 32-35）",
      "mode": "per_question",
      "items": [
        {
          "questionNumber": 32,
    ...
    },
    {
      ...
      "text": "答案：D (good condition)\n解析：定位 Paragraph F。原文提到手工艺品埋在泥炭层中，泥炭具有极好地保存木材的特性。保存完好即对应 good condition。\n答案：B (random collection)\n解析：定位 Paragraph F。原文指出测试中使用的散碳屑是从遗址的许多不同地方非系统地采集的，与手工艺品的关联性不明确。非系统采集对应 random collection。\n答案：C (similar properties)\n解析：定位 Paragraph G。原文指出这些手工艺品与洛斯托尔多斯的发现有相同的来源（same origins）。这表示它们具有相似的特征（similar properties）。\n答案：H (reliable connection)\n解析：定位 Paragraph G。原文说无法确切地将这些遗骸与人类居住联系起来（no way of securely relating... to human occupation）。无法确切联系对应 no reliable connection。\n答案：J (immediate surroundings)\n解析：定位 Paragraph G 末尾。原文指出鉴于洪水引起的变化，该遗址的用途必须限于其直接周边地区（direct vicinity）。直接周边地区对应 immediate surroundings。"
    }
  ]
}
  );
