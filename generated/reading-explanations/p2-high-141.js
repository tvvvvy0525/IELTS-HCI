(function registerReadingExplanationData(global) {
  ...
  global.__READING_EXPLANATION_DATA__.register("p2-high-141", {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "切叶蚁与其培育的真菌 “农场” 是自然界的奇迹，也是共生关系（两种生物相互依赖）的典型案例。蚂蚁在 “农场” 中培育蘑菇状真菌，两者及蚂蚁的 “农业行为” 多年来被广泛研究，近期研究又有新发现。蚂蚁比人类早 5000 万年发明农业，切叶蚁（庞大的阿庭蚁科成员）的农业方式最复杂 —— 它们在足球大小的地下巢穴中培育真菌，单个切叶蚁巢穴可能包含上千个这样的巢穴，深埋地下 18 英尺，支撑超 100 万只蚂蚁组成的社群。"
    },
    {
      "label": "Paragraph B",
      "text": "这些蚂蚁社群是新热带区（涵盖南美、中美、墨西哥和加勒比地区）的主要植食者。生物学家认为，热带森林 15% 的叶片产量被切叶蚁搬回巢穴。在巢穴中，叶片被切碎后用于培育真菌，真菌消化叶片后被蚂蚁食用。阿庭蚁的非凡之处在于，借助真菌的消化能力，它们能利用叶片含毒的热带森林资源。"
    },
    {
      "label": "Paragraph C",
      "text": "已知阿庭蚁族有 200 多种，分为 12 属。切叶蚁使用新鲜植被，其他类群（因巢穴小、技术原始被称为 “下位阿庭蚁”）则用落叶和地面昆虫培育真菌。下位阿庭蚁体型相近，而切叶蚁工蚁体型分工明确 —— 大型蚁锯叶、中型蚁碎叶、小型蚁接种真菌并清除外来生物。"
    },
    {
      "label": "Paragraph D",
      "text": "1994 年，美国农业部生物学家分析蚂蚁真菌的 DNA，发现切叶蚁的真菌源自单一纯菌株，已繁殖至少 2300 万年；而下位阿庭蚁培育的真菌分为四类，表明蚂蚁在进化史上至少四次驯化野生真菌。是什么导致两种真菌培育模式（切叶蚁的纯菌株培育 vs 下位阿庭蚁的多品种培育）的差异？"
    },
    {
      "label": "Paragraph E",
      "text": "多伦多大学的卡梅伦・柯里（Cameron Currie）提出了答案：切叶蚁培育的纯菌株，类似人类种植土豆等单一作物（ monocultures ），这种缺乏遗传多样性的作物易受寄生虫侵害（寄生虫依赖宿主生存并造成伤害）。柯里认为蚁菌系统中必然存在寄生虫，但一个世纪的蚂蚁研究未发现证据 —— 教科书称切叶蚁会仔细清除巢穴中的外来生物。柯里说：“人们总告诉我蚂蚁的农场无寄生虫”，但经过三年筛选阿庭蚁巢穴，他发现了多种外来生物，尤其是名为 “Escovopsis” 的寄生霉菌家族。"
    },
    {
      "label": "Paragraph F",
      "text": "Escovopsis 是致命病原体，可在几天内摧毁真菌农场，形成白色菌丝覆盖整个农场，其他蚂蚁避之不及，巢穴中的蚂蚁会饿死。显然，蚂蚁通常能控制 Escovopsis 及其他寄生虫，但一旦控制失效，Escovopsis 便会迅速蔓延。尽管新切叶蚁巢穴初始无 Escovopsis，但两年内约 60% 会被感染。"
    },
    {
      "label": "Paragraph G",
      "text": "Escovopsis 作用的发现，让人们对阿庭蚁进化有了新认识。过去十年，进化生物学家愈发意识到寄生虫在进化中的驱动作用。结合柯里的研究，下位阿庭蚁培育多种真菌的原因可能是 “领先 Escovopsis 一步”。有趣的是，切叶蚁巢穴中的外来霉菌少于下位阿庭蚁，但 Escovopsis 感染率更高 —— 显然，培育纯菌株的代价是更高的 Escovopsis 感染风险。"
    },
    {
      "label": "Paragraph H",
      "text": "那么阿庭蚁如何控制这种寄生虫？人们百年前就发现蚂蚁体表有白色物质，曾以为是蜡质，但柯里通过显微镜观察发现，蚂蚁体表有特殊区域寄生着一种细菌，这种细菌是制药业熟知的抗生素来源（提供人类使用的一半抗生素）。该细菌能有效抑制 Escovopsis 生长和孢子形成。令人震惊的是，切叶蚁实现了人类无法做到的成就：年复一年种植单一作物而无灾害，且使用抗生素时不会像人类那样导致病原体产生耐药性。"
    }
  ],
  "questionExplanations": [
    ...
    {
      "sectionTitle": "2. 分类题（Questions 20–24：A Leaf-cutting ants / B Lower attines / C Both）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 20,
      ...
      "text": "答案：B（Lower attines，下位阿庭蚁）\n解析：定位 Paragraph C 中 “the lower attines... feed their gardens with similar leaves that have fallen on the ground and insects that lie on the forest floor”，明确提到下位阿庭蚁用落叶，因此选 B。\n答案：A（Leaf-cutting ants，切叶蚁）\n解析：定位 Paragraph C 中 “miniature workers to seed them with fungus and clean off alien growths”，明确提到切叶蚁的小型工蚁负责清洁，因此选 A。\n答案：C（Both，两者皆是）\n解析：定位 Paragraph B 中 “The attine ants’ achievement is remarkable because it allows them to consume... the harvest of tropical forests whose leaves are laden with poisonous chemicals”，“attine ants” 涵盖切叶蚁和下位阿庭蚁，因此选 C。\n答案：A（Leaf-cutting ants，切叶蚁）\n解析：定位 Paragraph D 中 “the leaf-cutters’ fungus was descended from a single pure strain”，明确提到切叶蚁培育纯菌株，因此选 A。\n答案：A（Leaf-cutting ants，切叶蚁）\n解析：定位 Paragraph A 中 “A single leaf-cutter nest may contain a thousand such chambers”，明确提到切叶蚁巢穴有上千个培育室，因此选 A。"
    },
    {
      "sectionTitle": "3. 单选题（Questions 25–26：Choose the correct letter）",
      "mode": "per_question",
      "items": [
        {
          "questionNumber": 25,
      ...
      "text": "答案：B（Earlier studies did not support his theory. 早期研究不支持他的理论）\n解析：定位 Paragraph E 中 “a century of ant research had provided no evidence for his idea. Textbooks describe how leaf-cutter ants scrupulously weed their gardens of all foreign organisms”，明确提到早期研究和教科书均不支持柯里的 “存在寄生虫” 理论，因此选 B。\n答案：D（has a substance useful to humans. 有对人类有用的物质）\n解析：定位 Paragraph H 中 “Currie discovered a specialised patch on the ants’ bodies that harbours a particular kind of bacterium... the source of half the antibiotics used in medicine”，明确提到细菌是人类抗生素的来源，即 “对人类有用的物质”，因此选 D。"
    }
  ]
}
  );
