(function registerReadingExplanationData(global) {
  ...
  global.__READING_EXPLANATION_DATA__.register("p2-high-145", {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "哥斯达黎加北部瓜纳卡斯特省的哈西恩达・拉太平洋牧场（Hacienda La Pacifica），数十年来一直是卷尾猴的栖息地。白面卷尾猴和蜘蛛猴曾在此常见，但 1950 年代泛美公路修建后，周边土地多被清理用于养牛，这两种猴子随之消失。而该牧场主颇具远见，保留了部分原生树木作为防风林，意外为猴子研究提供了独特场所。"
    },
    {
      "label": "Paragraph B",
      "text": "美国杜克大学灵长类动物学家肯・格兰德（Ken Glander）研究该牧场的猴子，旨在了解卷尾猴与牧场边缘再生森林的关系。研究这类受干扰的林地日益重要 —— 在新热带区多数地区，这类森林已成为仅存的植被。18 世纪，热带干旱森林曾覆盖中美洲大部分地区，但到 1980 年代，未受干扰的森林不足 2%，受保护的不足 1%。"
    },
    {
      "label": "Paragraph C",
      "text": "格兰德解释，卷尾猴能在拉太平洋牧场存活，因其以树叶为食（有果实时也吃水果），不像卷尾猴和蜘蛛猴依赖大片果树。格兰德特别关注卷尾猴食用含毒树叶的能力 —— 植物产生毒素保护自身，而食叶动物长期接触特定毒素后，解毒和吸收营养的能力会增强。观察拉太平洋牧场的卷尾猴种群发现，它们通过尝试多种植物，最终聚焦少数高营养种类，维持身体解毒能力。此外，牧场的再生森林树叶比南部古老森林更适合卷尾猴 —— 幼林树木将有限能量用于生长，毒素含量远低于成熟森林。"
    },
    {
      "label": "Paragraph D",
      "text": "再生森林对灵长类的价值，也是拉太平洋牧场西北 35 英里的圣罗莎国家公园（Santa Rosa National Park）的研究主题。该公园曾因养牛和咖啡种植烧林，严重破坏猴子栖息地；1971 年政府将其设为国家公园后，消失数十年的原生树木开始在废弃牧场生长。卷尾猴最先进入再生森林，随后是吼猴，最终连需大片连续森林的食果蜘蛛猴也回归。在保护后的 28 年里，卷尾猴数量翻倍，吼猴数量增长 7 倍。"
    },
    {
      "label": "Paragraph E",
      "text": "吼猴在拉太平洋牧场存活的特性，也解释了其在圣罗莎的数量激增：吼猴繁殖速度快（首次生育约 3.5 岁，卷尾猴需 7 岁，蜘蛛猴需 8 岁以上），营养充足时每两年产仔（蜘蛛猴每四年一次）；食性适应强，栖息地范围小；树叶含水量高，无需依赖溪流，在长期干旱中比其他猴子更具优势。"
    },
    {
      "label": "Paragraph F",
      "text": "墨西哥韦拉克鲁斯州洛斯图斯特拉斯生物站的生态学家亚历杭德罗・埃斯特拉达（Alejandro Estrada），研究了墨西哥塔巴斯科州可可种植园中的吼猴 ——40 年前，种植园主种植无花果树等高大树木为可可遮阴，25 年前周边森林砍伐后，吼猴迁入。该栖息地的猴子数量与同等面积野生森林相当，且吼猴仅吃遮阴树的叶和果实，不破坏珍贵的可可豆荚。"
    },
    {
      "label": "Paragraph G",
      "text": "埃斯特拉达认为，猴子为种植园带来未被重视的益处（传播种子、肥沃土壤），蜘蛛猴也在此觅食（需周边森林长期存活）。他希望农民认识到与野生猴子共存的优势（如生态旅游），并指出：“保护不再被视为农业与自然的冲突，而是探索商业活动成为人类改造景观中灵长类保护工具的途径。”"
    }
  ],
  "questionExplanations": [
    ...
    {
      "sectionTitle": "2. 摘要填空（Questions 18–21：ONE WORD ONLY）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 18,
      ...
      "text": "题目翻译：吼猴的_\\___\\__速度比卷尾猴和蜘蛛猴更快。\n答案：reproduction（繁殖）\n解析：定位 Paragraph E 中 “Howler reproduction is faster than that of other native monkey species”，明确提到 “繁殖速度快”，因此答案为 “reproduction”。\n题目翻译：与其他本地猴子不同，吼猴无需食用_\\___\\__即可生存，因此栖息地范围相对较小。\n答案：fruit（水果）\n解析：定位 Paragraph C 中 “they eat fruit when it is available but, unlike capuchin and spider monkeys, do not depend on large areas of fruiting trees”，明确提到 “不依赖水果”，因此答案为 “fruit”。\n题目翻译：它们的食性更灵活，能耐受含高浓度_\\___\\__的树叶。\n答案：toxins（毒素）\n解析：定位 Paragraph C 中 “howlers’ ability to thrive on leaves loaded with toxins”，明确提到 “耐受毒素”，因此答案为 “toxins”。\n题目翻译：吼猴在_\\___\\__期间的存活能力也优于其他猴子。\n答案：drought（干旱）\n解析：定位 Paragraph E 中 “this ability gives them a real advantage over capuchin and spider monkeys, which have suffered during the long, ongoing drought in the area”，明确提到 “干旱期间更易存活”，因此答案为 “drought”。"
    },
    {
      "sectionTitle": "3. 地点 - 特征匹配（Questions 22–26：Match each feature with the correct location）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 22,
      ...
      "text": "答案：B（Santa Rosa National Park，圣罗莎国家公园）\n解析：定位 Paragraph D 中 “species of indigenous trees which had been absent for decades began to invade the abandoned pastures”，明确提到圣罗莎原生树木回归，因此选 B。\n答案：A（Hacienda La Pacifica，哈西恩达・拉太平洋牧场）\n解析：定位 Paragraph A 中 “has for decades been home to a community of mantled howler monkeys. Other native primates... vanished”，明确提到牧场仅存吼猴，因此选 A。\n答案：C（Cholula Cacao Farm，乔卢拉可可农场）\n解析：定位 Paragraph G 中 “the monkeys bring under-appreciated benefits to such plantations, dispersing the seeds... and fertilising the soil”，明确提到可可农场的猴子传播种子、肥沃土壤，因此选 C。\n答案：B（Santa Rosa National Park，圣罗莎国家公园）\n解析：定位 Paragraph D 中 “Capuchins were the first... followed by howlers. Eventually, even spider monkeys... returned”，明确提到三种猴子均回归圣罗莎，因此选 B。\n答案：A（Hacienda La Pacifica，哈西恩达・拉太平洋牧场）\n解析：定位 Paragraph A 中 “vanished after the Pan-American Highway was built nearby in the 1950s and most of the surrounding land was cleared for cattle-raising”，明确提到牧场周边因公路建设改变地貌，因此选 A。"
    }
  ]
}
  );
