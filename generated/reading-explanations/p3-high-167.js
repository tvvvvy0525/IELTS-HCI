(function registerReadingExplanationData(global) {
  ...
  global.__READING_EXPLANATION_DATA__.register("p3-high-167", {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "巨型沙丘群在全球沙漠推进，吞噬路径上的一切，虽移动缓慢（小型沙丘年移 100 米，大型沙丘年移 1 米），但若阻挡油田设施或铁路，其隐蔽的移动会造成严重后果。"
    },
    {
      "label": "Paragraph B",
      "text": "全球 47% 陆地（含南极、澳大利亚大部分地区、非洲大片区域）为干旱或半干旱沙漠，仅 20% 被沙覆盖，其中超一半是 “线形沙丘（linear dunes）”—— 由多方向强风作用形成长弯曲波形，虽静止不动，但沙丘吹落的沙子会掩埋沙漠村庄的作物和建筑。"
    },
    {
      "label": "Paragraph C",
      "text": "流动沙丘占比虽小，却最受科学家关注，这类 “新月形沙丘（barchans）” 呈月牙状，脊部凸起、两侧延伸，仅形成于 “沙漠边缘近海地区、单向风” 环境（牛津大学地貌学家贾尔斯・威格斯研究结论）。"
    },
    {
      "label": "Paragraph D",
      "text": "英国探险家拉尔夫・阿尔杰・巴格诺尔德（Ralph Alger Bagnold）在 20 世纪中期解释了 “新月形沙丘如何保持形态移动”—— 沙丘由沙粒构成而非固体：沙粒被风吹上沙丘背坡并堆积，重量超过临界值后从坡顶滑落，最终在背坡重新出现，循环往复推动沙丘沿主导风向移动。"
    },
    {
      "label": "Paragraph E",
      "text": "风与新月形沙丘的关系复杂 —— 沙丘生长会改变风速和风向，进而影响自身及周边沙丘演变，法国高等师范学院物理学家斯特凡纳・杜阿迪（Stéphane Douady）指出 “沙丘能自我调节形态，移动时保持特征，即便两丘相撞也能快速恢复原状，类似生命体”。"
    },
    {
      "label": "Paragraph F",
      "text": "杜阿迪团队还研究了 “沙丘发声” 这一更奇特现象 —— 当地传说将声音归因于诱捕旅行者的恶灵，而杜阿迪解释为 “低频轰鸣（持续数分钟）”，全球 35 个沙漠中约 50 个沙丘会发声。声音由 “沙粒沿特定沙丘坡面滑落” 产生：沙粒同步流动而非随机翻滚，相互振动如巨型扬声器膜，带动空气在颗粒间进出，形成强力声波。"
    },
    {
      "label": "Paragraph G",
      "text": "科学家将 “发声沙” 样本带回法国实验室，成功复制声音，证明 “发声关键是沙粒而非沙丘形态”：沙粒形状均匀（长期碰撞磨圆），大小差异影响音调，且表面覆盖 “沙漠釉层（desert glaze）”（由铁、铝、锰、硅、钙等矿物构成）。釉层磨损后沙粒会 “失声”，人工恢复釉层可使其重新发声（美国研究者用人工沙粒 + 釉层也实现发声）。杜阿迪已录制全球沙丘声音，计划制成 CD。"
    }
  ],
  "questionExplanations": [
    {
      ...
      "text": "答案：iv（A potential threat to industry and communications，对工业和交通的潜在威胁）\n解析：Paragraph A 强调 “沙丘移动若阻挡油田、铁路会造成严重后果”，核心是 “威胁工业与交通”，与标题 iv 一致，因此选 iv。\n答案：viii（The commonest type of dune，最常见的沙丘类型）\n解析：Paragraph B 指出 “线形沙丘占沙覆盖区超一半”，核心是 “最常见类型”，与标题 viii 一致，因此选 viii。\n答案：vi（Needing a specific combination of conditions，需要特定条件组合）\n解析：Paragraph C 说明 “新月形沙丘仅形成于‘单向风、沙漠边缘、近海’环境”，核心是 “特定形成条件”，与标题 vi 一致，因此选 vi。\n答案：vii（A continuous cycle，持续循环）\n解析：Paragraph D 描述 “沙粒‘上坡 - 滑落 - 重现’的循环推动沙丘移动”，核心是 “循环过程”，与标题 vii 一致，因此选 vii。\n答案：v（Dunes coming together and re-forming，沙丘相撞后重新形成）\n解析：Paragraph E 提到 “两沙丘相撞后快速恢复原状”，核心是 “相撞与重组”，与标题 v 一致，因此选 v。\n答案：ix（Old superstitions demystified，旧迷信被解开）\n解析：Paragraph F 用科学解释取代 “恶灵发声” 的传说，核心是 “破除迷信”，与标题 ix 一致，因此选 ix。\n答案：ii（Recreating the process in a laboratory，在实验室重现过程）\n解析：Paragraph G 描述 “实验室复制沙丘发声”，核心是 “实验室重现”，与标题 ii 一致，因此选 ii。"
    },
    {
      "sectionTitle": "2. 单选题（Questions 34–36：Choose A–D）",
      "mode": "per_question",
      "items": [
        {
          "questionNumber": 34,
      ...
      "text": "答案：C（They develop in a recognisable shape. 形成可识别的形状）\n解析：定位 Paragraph B 中 “These form in a long curving wave”，“长弯曲波形” 对应 “可识别的形状”，因此选 C。A “单向风形成” 错误（线形沙丘由多方向风形成）；B “年移 100 米” 错误（线形沙丘静止）；D“占全球沙漠 20%” 错误（20% 是沙漠中沙覆盖区比例）。\n答案：B（the particular composition of the dunes. 沙丘的特定构成）\n解析：定位 Paragraph D 中 “his answer hinges on the fact that dunes aren’t solid, but granular. Bagnold figured out how barchan dunes are able to move grain by grain”，“由沙粒构成而非固体” 对应 “特定构成”，因此选 B。\n答案：D（Its outline stays the same even after a period of movement. 移动后仍保持轮廓不变）\n解析：定位 Paragraph E 中 “the dune can regulate its own shape, and maintain it as it moves... Even when two dunes collide, they quickly take on their distinctive shapes again”，“保持并恢复形态” 对应 “轮廓不变”，因此选 D。"
    },
    {
      "sectionTitle": "3. 摘要填空（Questions 37–40：ONE WORD ONLY）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 37,
