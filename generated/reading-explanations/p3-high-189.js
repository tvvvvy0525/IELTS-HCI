(function registerReadingExplanationData(global) {
  ...
  global.__READING_EXPLANATION_DATA__.register("p3-high-189", {
  ...
  "passageNotes": [
    {
      "label": "段落 1",
      "text": "Paragraph 1\n新西兰的一种蜥蜴——喙头蜥（tuatara），牢牢植根于国民的集体意识之中：它既是当代的象征，又可追溯到恐龙时代；这一远古的爬行动物甚至被铸刻在五分硬币（five-cent coin）的背面。新西兰人对喙头蜥（tuatara）怀有亲近感，并接受这样一个事实：必须采取积极的保护管理措施，才能确保它成为留给后代的遗产之一。\nParagraph 2\n当欧洲探险者于 1769 年抵达新西兰时，他们发现了两座大片的岛屿——并将其合称为“大陆”（the mainland）——以及散布在海岸周围的许多小型离岸岛屿（offshore islands）。随行的博物学家（naturalists）忽视了喙头蜥（tuatara）的存在，尽管他们极不可能完全没看到这种动物。直到几十年后，一只喙头蜥标本（tuatara specimen）才被送到大英博物，并最终被归类为一种普通蜥蜴。\nParagraph 3\n第一批意识到喙头蜥（tuatara）解剖结构存在奇特之处——并在数万年间几乎未发生变化——的是 1876 年的科学家阿尔伯特·冈瑟（Albert Gunther）。冈瑟（Gunther）认为喙头蜥（tuatara）是动物学解剖收藏中最珍贵的标本之一，也顺带提到这种爬行动物很可能会灭绝。从现代视角来看，冈瑟（Gunther）对喙头蜥可能消亡一事毫无忧虑，确实颇为引人注目。他和他的同时代人深受当时思想影响，尤其是查尔斯·达尔文（Charles Darwin）刚发表不久的理论。他们的看法大致是：“物种灭绝是自然过程。物种消失虽然可悲，但这是自然的一部分。”\nParagraph 4\n冈瑟（Gunther）研究的第二个重要方面在于，他准确记录了欧洲人引入的一些哺乳动物是喙头蜥（tuatara）的捕食者——尤其是老鼠。然而，他没有意识到新西兰有两种老鼠，同样由人类带入，也同样以喙头蜥为食：航海鼠随欧洲探险者和移民而来；而基奥雷鼠则早在数百年前由来自太平洋群岛（Pacific Islands）的波利尼西亚人（Polynesians）带来。冈瑟（Gunther）未能分辨这一差别，以为所有老鼠都是近代才被引入的。"
    },
    {
      "label": "Paragraph 5",
      "text": "一直到 1973 年，新西兰野生动物局的伊恩·克鲁克（Ian Crook）发表研究成果，结论如下：喙头蜥（tuatara）在没有老鼠的离岸岛屿（offshore islands）上繁盛；在有航海鼠的岛屿上从未存活；在少数岛屿上存在与基奥雷鼠共存的小而逐渐减少的群体。然而，这并不意味着喙头蜥和基奥雷鼠能够共存；相反，克鲁克（Crook）认为基奥雷鼠可能是近期才进入这些岛屿，因此这些小型种群其实是正在发生的灭绝过程。\nParagraph 6\n1990 年代期间，惠灵顿维多利亚大学的理查德·霍尔德韦（Richard Holdaway）及其同事记录了一个惊人的发现：基奥雷鼠可能在大约 1800 年前就来到新西兰，尽管人类定居新西兰的历史一般认为不超过 800 年。这怎么可能？霍尔德韦（Holdaway）推测——基奥雷鼠是由造访但未定居的波利尼西亚探险者（Polynesian explorers）带来的。此后，这些老鼠成为“生态战争”（ecological warfare）的武器，消灭了约 1000–3000 种物种。因此，在永久居民——毛利人（Maori）——约于 1300 年抵达之前，喙头蜥（tuatara）及许多其他物种已变得稀少或灭绝。此假说尚在争论，但证据不断加强其可信度。\nParagraph 7\n自克鲁克（Crook）1973 年的研究发表以来，保护实践发生巨大变化。直到 1980 年左右，人们仍认为几乎不可能从环境中根除老鼠；而此后，这成为常规操作。随着越来越多的离岸岛屿（offshore islands）成功清除老鼠，它们开始成为全国稀有物种的庇护所。例如，1995 年，保护部的尼古拉·尼尔森（Nicola Nelson）在蒂蒂岛（Titi Island）放归了 68 只喙头蜥（tuatara）。随后，又有四个喙头蜥群体在类似条件下被建立。尽管今日喙头蜥数量仍只是过去的一小部分，但这是 1800 年以来首次出现增长。\nParagraph 8\n虽然稀有物种的恢复本身就是好事，但这项研究真正重要之处在于——它解放了人们的想象力。如果我们能够从岛屿上清除外来哺乳动物捕食者，为什么不能从大陆（mainland）上清除呢？或许我们提出的问题应更具远见。能否从大陆上清除非哺乳类的有害物种？例如，河流（rivers）中充满了“替代老鼠”——外来鱼类鳟鱼（trout）。当更多人意识到鳟鱼取代了河流中原有的本土鱼类群落（native fauna）（正如老鼠取代喙头蜥）时，这是否会促成大陆“水域岛屿”（aquatic islands）的形成，使曾经的本土鱼类重新回归？同样，钟鹎（bellbirds）和吸蜜鸟（tuis）是否能重新取代八哥（starlings）和椋鸟（mynahs）？\nParagraph 9\n这些问题的答案仍不确定，支持与反对者必然会展开激烈辩论。然而，科学知识在照亮过去方面的作用至关重要。正如我们如今不再容忍物种灭绝，将来我们也可能不再接受一个缺乏过去生物奇迹（biological wonders）——如喙头蜥（tuatara）——的大陆（mainland）。因此，保护不仅关乎过去，更关乎想象未来，并为孩子与我们自己打造我们所期望的世界。在人类到来之前的八千万年间，喙头蜥（tuatara）曾遍布整个新西兰——难道不能再次如此吗？"
    }
  ],
  "questionExplanations": [
    {
      ...
      "text": "答案：C（They had no interest in the tuatara. 他们对楔齿蜥无兴趣）\n解析：定位 Paragraph 2 中 “The naturalists who came with the explorers disregarded the tuatara”，“博物学家忽视楔齿蜥” 即 “对其无兴趣”，因此选 C。A（认为只有一座大岛）、B（非为研究自然史而来）、D（将楔齿蜥标本送博物馆）均与原文矛盾。\n答案：B（He was typical of his generation of scientists. 他是同时代科学家的典型代表）\n解析：定位 Paragraph 3 中 “He and his contemporaries were products of their age, strongly influenced by Charles Darwin’s theory”，“冈瑟的观点与同时代人一致，受达尔文理论影响” 即 “典型代表”，因此选 B。A（认为楔齿蜥可卖高价）、C（不同意达尔文理论）、D（想阻止楔齿蜥灭绝）均与原文矛盾。\n答案：B（There was one species of rat. 只有一种老鼠）\n解析：定位 Paragraph 4 中 “Gunther failed to recognise the distinction, believing all rats to be a relatively recent introduction”，“冈瑟未区分两种老鼠，认为所有老鼠都是同一类” 即 “只有一种老鼠”，因此选 B。A（老鼠不吃楔齿蜥）、C（老鼠一直存在于新西兰）、D（被波利尼西亚人消灭）均与原文矛盾。\n答案：D（Rats and tuatara cannot live together. 老鼠和楔齿蜥无法共存）\n解析：定位 Paragraph 5 中 “Tuatara thrive on offshore islands with no rats. Tuatara never survived on islands with ship’s rats... the small populations represent extinctions in progress”，“无鼠则楔齿蜥繁荣，有鼠则楔齿蜥灭绝” 即 “无法共存”，因此选 D。A（楔齿蜥在小岛安全）、B（船运鼠比 kiore 鼠更危险）、C（kiore 鼠不能游泳到近海小岛）均未提及。\n答案：D（Rats caused extinctions before any humans settled. 人类定居前，老鼠已导致物种灭绝）\n解析：定位 Paragraph 6 中 “the rats were agents of ecological warfare, exterminating perhaps 1,000–3,000 species. Thus, tuatara and many other species were already rare or extinct when permanent human inhabitants- the Maori-arrived around 1300”，“人类定居前老鼠已导致大量物种灭绝”，因此选 D。A（毛利人定居时间比之前认为的更晚）、B（首批波利尼西亚探险家建立永久定居点）、C（船运鼠是新西兰最古老的老鼠物种）均与原文矛盾。"
    },
    {
    ...
    {
      "sectionTitle": "3. 摘要填空（Questions 36–40：Choose A–H）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 36,
      ...
      "text": "答案：B（creative thought，创造性思维）\n解析：定位 Paragraph 8 中 “the truly significant outcome of this research is that it liberates the imagination”，“解放想象力” 对应 “frees our creative thought”，因此选 B。\n答案：D（trout，鳟鱼）\n解析：定位 Paragraph 8 中 “our rivers, for example, are full of surrogate rats, in the form of introduced species of fish called trout”，“鳟鱼是老鼠的‘替代品’” 即 “两者有相似之处（均为引入物种，取代原生生物）”，因此选 D。\n答案：G（native fish，原生鱼类）\n解析：定位 Paragraph 8 中 “Will such knowledge lead to the creation of mainland ‘aquatic islands’ where we can once again establish those species of indigenous fish that used to live in our rivers?”，“重新引入曾生活在河流中的原生鱼类” 对应 “reintroducing native fish”，因此选 G。\n答案：F（restoration，恢复）；H（extinction，灭绝）\n解析：定位 Paragraph 9 中 “Just as we no longer tolerate extinction, in the future we may no longer accept a mainland devoid of the biological wonders of our past such as tuatara. Conservation is thus not primarily about the past but about imagining and then creating the future we wish for our children and ourselves”，“我们拒绝接受灭绝，后代可能相信物种可恢复”，因此依次填 “restoration”“extinction”。\n答案：H（extinction，灭绝）\n解析：定位 Paragraph 9 中 “Just as we no longer tolerate extinction”，“拒绝容忍灭绝” 对应 “refuses to accept extinction”，因此选 H。"
    }
  ]
}
  );
