(function registerReadingExplanationData(global) {
  ...
  global.__READING_EXPLANATION_DATA__.register("p2-low-122", {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "亲自然设计（Biophilic Design）是绿色建筑相关运动，近年在建筑界迅速发展。其核心前提是 “避免或最小化对自然环境的有害影响”，且同等重要的是 “在人造环境中提供并恢复人与自然的有益联系”。"
    },
    {
      "label": "Paragraph B",
      "text": "人类在心理上有与自然交流的需求，但这一需求常被忽视。建筑师常将创意创新置于使用者需求之上，忽视情感与实用考量。亲自然设计不主张树屋或洞穴居住，而是通过自然元素最大化人类机能与健康。尽管弗兰克・劳埃德・赖特（Frank Lloyd Wright）1930 年代设计的宾夕法尼亚乡村 “流水别墅（Fallingwater）” 并非严格的亲自然设计，但其对人类精神的感染力，远胜于同时代勒・柯布西耶（Le Corbusier）设计的盒状公寓楼。"
    },
    {
      "label": "Paragraph C",
      "text": "现代人造环境阻碍了人类与自然的古老联系。技术进步速度远超心理进化速度，使人类难以适应现代生活方式，进而导致压力增加。亲自然设计试图整合人类基本需求与现代需求，缓解大脑在 “尚未进化适应的现代环境” 中运作的困境。例如，阳光是自然环境中对人类健康至关重要的元素 —— 人类进化出对阳光的积极反应（偏好阳光区域而非阴暗区域），认为阳光能促进恢复、改善情绪、有益健康。"
    },
    {
      "label": "Paragraph D",
      "text": "因对人类心理影响巨大，亲自然设计在医疗保健领域至关重要。当前医疗体系存在诸多缺陷，尤其在物理空间方面 —— 医院、诊所和办公室对患者、访客和医护人员而言均是高压力环境。一项知名研究观察自然对术后患者的影响：一组患者病房窗外有树，另一组面对砖墙。结果显示，看树的患者住院时间更短、护士负面评价更少、止痛药使用更少、术后并发症略少。"
    },
    {
      "label": "Paragraph E",
      "text": "受此类研究影响，许多医院将自然元素融入物理设计。例如，新罕布什尔州达特茅斯 - 希区柯克医疗中心（DHMC）采用中庭设计，照亮整个建筑，木材、石材和大量绿植等自然元素遍布建筑。DHMC 在建造时就融入这些元素，而其他医院则在现有建筑中添加亲自然特征。随着管理者见证患者对自然的积极反应，医院内部亲自然设计的应用大幅增加。"
    },
    {
      "label": "Paragraph F",
      "text": "许多现有建筑包含亲自然元素，但极少建筑在设计时明确以亲自然理念为核心，俄亥俄州奥伯林学院的亚当・约瑟夫・刘易斯环境研究中心（Adam Joseph Lewis Center）便是其中之一。奥伯林环境研究项目主任大卫・奥尔（David Orr）解释，该建筑的目标 “不仅是打造教学空间，更是重新定义人类与环境的关系 —— 拓展人类对生态可能性的认知”。刘易斯中心的可持续性远超该词常规含义：利用太阳能、采用主动与被动通风系统、根据天气调整运行模式；中心的 “活机器（Living Machine）” 将传统废水处理技术与湿地生态系统净化过程结合，处理后的水可用于冲厕和灌溉。奥尔及其建筑师团队在设计中，既为学生打造健康舒适的空间，又确保周边环境不受破坏。"
    },
    {
      "label": "Paragraph G",
      "text": "另一案例是加拿大安大略省的圭尔夫 - 亨伯大学（University of Guelph-Humber）建筑，中央有一面贯穿建筑的垂直生物墙（bio-wall），墙面覆盖茂密植被。这面墙不仅让室内人员接触自然，还作为新型空气过滤系统原型 —— 净化空气，有望满足建筑新风需求。这些案例证明，人造环境无需阻碍人类与自然交流的生理需求，也无需破坏现有生态系统。"
    },
    {
      "label": "Paragraph H",
      "text": "古代建筑师为其文化而建，当时文化与自然的联系远比现代西方社会紧密。他们模仿自然形态，建造出至今仍令人惊叹的宏伟建筑 —— 尽管亲自然设计是新概念，但古人无疑采用了其中部分理念。如今，我们可在这一传统基础上进一步发展，确保人类与地球均能获得最大益处。"
    }
  ],
  "questionExplanations": [
    ...
    {
      "sectionTitle": "2. 句子填空（Questions 20–24：ONE WORD ONLY）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 20,
      ...
      "text": "题目翻译：现代社会，\\___\\___\\___\\_进步速度过快，人类难以适应。\n答案：technological（技术的）\n解析：定位 Paragraph C 中 “The rate of technological progress far exceeds the rate of psychological evolution, leaving us ill-equipped to cope”，“progress” 对应 “advancements”，明确提到 “技术进步过快”，因此答案为 “technological”。\n题目翻译：亲自然设计可帮助我们应对当前生活方式困境带来的_\\___\\___\\___。\n答案：stress（压力）\n解析：定位 Paragraph C 中 “which in turn leads to increased stress. Because biophilia attempts to integrate basic and current needs, it can alleviate the difficulties”，“alleviate the difficulties” 对应 “deal with”，明确提到亲自然设计缓解 “压力”，因此答案为 “stress”。\n题目翻译：人类本能地在_\\___\\___\\___充足的地方感到更舒适，这对健康和幸福至关重要。\n答案：sunlight（阳光）\n解析：定位 Paragraph C 中 “one crucial element of the natural landscape for human health is sunlight. We are evolutionarily programmed to respond positively to sunny areas”，明确提到 “阳光充足的地方让人舒适”，因此答案为 “sunlight”。\n题目翻译：一项测试自然对患者康复时间影响的实验发现，能看到_\\___\\___\\___的患者恢复更快。\n答案：tree（树）\n解析：定位 Paragraph D 中 “One group had a view of a tree; the others had a window looking onto a brick wall. The first group had shorter hospital stays”，明确提到 “看树的患者恢复更快”，因此答案为 “tree”。\n题目翻译：圭尔夫 - 亨伯大学建筑中有一项亲自然设计特征，可改善_\\___\\___\\___质量。\n答案：air（空气）\n解析：定位 Paragraph G 中 “The wall purifies the air and has the potential to fulfil the building’s fresh-air-intake requirements”，明确提到 “生物墙净化空气，改善空气质量”，因此答案为 “air”。"
    },
    {
      ...
      "text": "题目：Which TWO of the following statements does the writer make about the Adam Joseph Lewis Center at Oberlin College?（关于奥伯林学院亚当・约瑟夫・刘易斯中心，作者提到以下哪两项？）\n答案：B、D\n选项 B：It is beneficial for both students and the environment.（对学生和环境均有益）\n解析：定位 Paragraph F 中 “Orr and his team of architects engineered a healthy and comfortable space for students while ensuring the surrounding environment was undamaged”，明确提到 “为学生提供健康空间，且不破坏环境”，与 B 一致。\n- 选项 D：It aims to inspire new ways of thinking about the environment.（旨在启发人们以新方式思考环境）\n解析：定位 Paragraph F 中 “the building’s goals were ‘to create not just a place for classes but rather a building that would help to redefine the relationship between humankind and the environment-one that would expand our sense of ecological possibilities’”，“redefine the relationship”“expand our sense” 对应 “inspire new ways of thinking”，与 D 一致。\n- 排除 A：文中未提及 “首个亲自然教育建筑”；排除 C：文中未提及 “课堂设计新概念”；排除 E：文中仅提到 “利用太阳能”，未提及 “向周边建筑供电”。"
    }
  ]
}
  );
