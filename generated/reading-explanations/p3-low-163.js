(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "游乐设施设计师面临 “乐趣平衡” 难题 —— 为增加刺激，不断提高加速度，但把控难度大：过于保守则游客不愿重玩，过于激进则游客无法承受。专家认为人类身体已达加速度承受极限，设计师难以创新吸引回头客。问题在于长期缺乏真正创新，游乐场设施沦为 “生存挑战而非享受”，若无法突破身体极限，如何吸引游客？设计 “新颖、刺激且安全” 的设施需谨慎思考。"
    },
    {
      "label": "Paragraph B",
      "text": "20 世纪 70 年代，迪士尼委托德国设计师瓦尔特・斯滕格尔（Walter Stengel）设计巨型环形过山车，他向 NASA（美国航空航天局）咨询 “持续加速度对飞行员的影响”。NASA 研究显示，人类可承受的最大加速度为 9g（g 为重力加速度单位），超此值飞行员会昏迷，更高则造成严重内伤。因此，斯滕格尔规定公众设施的最大垂直加速度为 6g（且仅持续 1 秒左右），还严格限制加速度增长率（如禁止 45 度斜坡接入紧身环形轨道）。"
    },
    {
      "label": "Paragraph C",
      "text": "但更严格的安全限制加剧了 “寻找新颖刺激方式” 的需求。部分问题在于 “无论设施多刺激，游客几次体验后便知预期”，而新一代设计可打破可预测性 —— 最新的旋转杯（waltzer）已实现这一点：传统旋转杯由齿轮控制，转速由整体平台决定；新一代旋转杯可自由旋转，转速由乘客体重和位置决定，因此每次体验不同。斯滕格尔称 “人们似乎喜欢这种‘混乱型设施’”。"
    },
    {
      "label": "Paragraph D",
      "text": "尽管 “混乱” 看似带来无限刺激，却有明显缺陷 —— 不可预测性。尽管有复杂计算，设计师无法完全确保无异常（尤其自由旋转系统可能触发共振频率）。例如，按特定频率推秋千，儿童会荡出框架；同理，若旋转杯被驱动至共振频率，可能失控加速。斯滕格尔指出这极具危险，若设施承受意外压力，无人能保证其安全。"
    },
    {
      "label": "Paragraph E",
      "text": "人类对旋转力的安全极限及影响一无所知。斯滕格尔与德国空军合作，让志愿者头脚颠倒旋转，同时像芭蕾舞演员一样侧翻或旋转，发现若在三个轴同时旋转，飞行员会恶心到几乎昏迷，下车后无法行走。更令人困惑的是，两天后他们还会出现头痛等症状。由于这些影响未被理解，斯滕格尔试图限制设施旋转方式 —— 人们想要乐趣，而非痛苦。"
    },
    {
      "label": "Paragraph F",
      "text": "基于这一目标，斯滕格尔认为 “用更混乱的机器甩动游客” 不再可行，他主张 “加速度的顺序比大小更重要”，通过 “精心设计的一系列较小加速度” 提升乐趣，该观点获同行认同。设计师甚至可优化现有设施的加速度曲线，提高娱乐价值。荷兰空军飞行员的耐受实验显示，“低力度翻滚并非不愉快 —— 当力值较低时，受试者实际享受体验”。"
    },
    {
      "label": "Paragraph G",
      "text": "乐趣源于 “意外”，尤其 “科里奥利错觉（Coriolis illusion）” 产生时 —— 例如，闭眼旋转时突然抬头，会产生愉悦的翻滚感。研究发现，“从微小负 g（失重感）到微小正 g（轻微压迫感）的意外加速度变化” 有非凡效果。若斯滕格尔等专家的理论可行，未来游乐场的乐趣可能以 “微笑而非尖叫” 衡量。"
    }
  ],
  "questionExplanations": [
    {
      "sectionTitle": "1. 段落标题匹配（Questions 27–32：Choose the correct heading）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 27,
    ...
    },
    {
      ...
      "text": "答案：weight and position（体重和位置）\n解析：定位 Paragraph C 中 “the latest generation of waltzer cars spin freely, at a rate determined by the weight and position of the people in them”，明确提到 “体重和位置”，因此答案为 “weight and position”。\n答案：resonance frequency（共振频率）\n解析：定位 Paragraph D 中 “if you drive a revolving waltzer car at its resonance frequency it could speed up uncontrollably”，明确提到 “共振频率”，因此答案为 “resonance frequency”。\n答案：three axes（三个轴）\n解析：定位 Paragraph E 中 “if the pilots were turned on all three axes simultaneously, they became so nauseous they almost blacked out”，明确提到 “三个轴”，因此答案为 “three axes”。\n答案：headaches（头痛）\n解析：定位 Paragraph E 中 “they also developed headaches and other problems about two days later”，明确提到 “头痛”，因此答案为 “headaches”。\n答案：Coriolis illusion（科里奥利错觉）\n解析：定位 Paragraph G 中 “particularly when an effect called the Coriolis illusion comes into play. This is an agreeable tumbling feeling”，明确提到 “科里奥利错觉”，因此答案为 “Coriolis illusion”。"
    },
    {
