(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "Paragraph 1",
      "text": "菲什伯恩罗马宫殿位于英国西萨塞克斯郡的菲什伯恩村，建于 1 世纪 AD（罗马征服英国后约 30 年），原址是 43AD 克劳狄乌斯皇帝统治时期建立的罗马军队谷物仓库。宫殿为矩形，围绕正式花园而建（北半部分已重建）；2-3 世纪 AD 进行了大规模改建，许多原始黑白马赛克地板被更复杂的彩色马赛克取代（含北翼保存完好的海豚马赛克）；约 270AD 宫殿焚毁时，改建仍在进行，此后被废弃。"
    },
    {
      "label": "Paragraph 2",
      "text": "当地人长期认为该地区曾有罗马宫殿，但直到 1960 年，牛津大学考古学家巴里・坎利夫（Barry Cunliffe）才首次对遗址进行系统挖掘 —— 此前工人铺设水管时意外发现了一堵墙。坎利夫团队挖掘的罗马别墅因规模宏大被称为 “菲什伯恩罗马宫殿”，后建造博物馆保护部分遗迹，由萨塞克斯考古学会管理。"
    },
    {
      "label": "Paragraph 3",
      "text": "宫殿建成时包含四翼，正面均有柱廊：北翼和东翼是围绕庭院的私人套房（东翼中部有宏伟入口），东北角有集会大厅；西翼有国务厅、大型礼仪接待室和走廊；南翼是主人私人公寓。宫殿有多达 50 块马赛克地板、地板下中央供暖系统和浴室，规模与意大利部分宏伟罗马宫殿相当，是欧洲阿尔卑斯山以北已知最大的罗马住宅（约 150 米见方）。志愿者和专业考古学家团队仍在附近可能为军事建筑的遗址进行持续挖掘。"
    },
    {
      "label": "Paragraph 4",
      "text": "遗址上最早的建筑建于 43AD 罗马征服初期，后建造了两座木结构建筑（一座有黏土灰泥地板和灰泥墙，居住舒适）；60 年代 AD 这些建筑被拆除，取而代之的是一座坚固的石屋（含柱廊和浴室套房）。有观点认为，宫殿（东南部融入此前石屋）建于 73-75AD 左右，但伯恩茅斯大学的迈尔斯・拉塞尔（Miles Russell）通过重新解读平面图和出土文物提出，因宫殿与罗马图密善皇帝的皇宫高度相似，其建造时间更可能在 92AD 之后。"
    },
    {
      "label": "Paragraph 5-6",
      "text": "关于宫殿居住者有多种理论：坎利夫教授认为早期居住者是支持罗马的当地首领提比略・克劳狄乌斯・科吉杜布努斯（Tiberius Claudius Cogidubnus），他在征服初期可能被任命为多个地区的国王（罗马作家塔西佗的《阿格里科拉传》提及他的忠诚，奇切斯特市发现纪念他建造海神尼普顿和智慧女神密涅瓦神庙的铭文）；另一理论认为宫殿为 1 世纪末罗马不列颠总督萨卢斯提乌斯・卢库卢斯（Sallustius Lucullus）建造，他可能是不列颠王子阿德米尼乌斯之子（奇切斯特发现两处记录卢库卢斯的铭文），拉塞尔的年代重新判定显示，若宫殿为卢库卢斯设计，可能仅使用数年 —— 罗马历史学家苏维托尼乌斯记载卢库卢斯在 93AD 或之后被图密善皇帝处决。"
    },
    {
      "label": "段落 6",
      "text": "此外，还有理论认为主人是克劳狄乌斯征服前的不列颠国王维里卡（Verica），或近期因出土其金戒指而被提及的提比略・克劳狄乌斯・卡图阿斯（Tiberius Claudius Catuarus）。宫殿比最初主人存在更久，2 世纪初进行大规模重新规划，拆分为多个小公寓；3 世纪末开始进一步重建，但约 270AD 北翼焚毁时改建未完成，损坏严重无法修复，宫殿被废弃后拆解。"
    },
    {
      "label": "Paragraph 7",
      "text": "萨塞克斯考古学会建造了一座现代博物馆，包含大部分可见遗迹（含宫殿一翼），花园也用罗马时期的原生植物重新种植。"
    }
  ],
