(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "Paragraph 1",
      "text": "玛格丽特・马希（Margaret Mahy）在五十年创作生涯中，以创新小说和独特人物塑造在新西兰文学中占据独特地位 —— 在新西兰现实主义传统中，她儿童文学的华丽语言和青少年超自然小说对人类行为的探索独树一帜。作者认为马希最直接的继承者是伊丽莎白・诺克斯（Elizabeth Knox），两人的共性是 “独特性”，马希探索了其他新西兰作家未触及的想象领域。作者近期拜访马希，她对记者慷慨但 “不愿将自己或生活作为谈话核心”。"
    },
    {
      "label": "Paragraph 2",
      "text": "关于马希的创作风格有诸多理论 —— 作为靠写作谋生的作家，她很少有时间进行正式研究，而是从即时环境中获取灵感（公交车身文字、给自己的便条拼写错误、猫与皮帽的相似性）。尽管灵感来源平凡，故事背景却丰富多样（海上冒险、南极探险、图书馆甚至家中椅背后）。马希一直偏爱 “制造混乱的角色”，儿童绘本中充满海盗、强盗、狮子（与图书管理员、母亲、儿童并存，打破刻板印象）；小说核心常是 “拥有特殊能力的青少年”（如施法改变世界）；另一个常见特征是 “结局可预测但完整，主角能力引发的道德问题得以解决”。"
    },
    {
      "label": "Paragraph 3",
      "text": "这些主题在新作《霍阿德的魔术师》（The Magician of Hoad）中均有体现 —— 该书始于 15 年前，最初设想为 “完整奇幻故事”（设定在虚构世界，有详细历史和复杂部落关系，核心是经典英雄探索），曾膨胀至 800 页，至少经历两次大幅重写，现篇幅减半，融合冒险、浪漫与马希的文学关注点，极具可读性。"
    },
    {
      "label": "Paragraph 4",
      "text": "今年另一本佳作是《泡泡麻烦》（Bubble Trouble）的插图重版 —— 这部绕口令故事 1991 年首次出版，1993 年入选《100 首新西兰诗歌》，马希在无数公私场合朗诵，是新西兰家庭最熟悉的马希作品，讲述小丑玩转文字游戏和意外押韵的欢乐故事。"
    },
    {
      "label": "Paragraph 5",
      "text": "马希的作品跨世代受欢迎 —— 作者本人 1960 年代读《草地上的狮子》，继女 1970 年代反复听《被跟踪回家的男孩》，作者子女 1980-90 年代读《大白食人鲨》，孙辈 21 世纪听《龙舌之下》等作品。"
    },
    {
      "label": "Paragraph 6",
      "text": "读者对作家至关重要，而马希对阅读的重视更甚 —— 她常说 “书在被阅读前不算真正完成，因读者为书带来重要价值”。因此，她一方面为开拓市场（清楚自身受欢迎程度），另一方面出于对 “作者 - 读者关系” 的真诚关注，直到近期仍保持密集的公开活动。"
    },
    {
      "label": "Paragraph 7",
      "text": "与马希私下交谈充满惊喜 —— 她思维活跃，曾突然去查百科全书确认 L.M. 蒙哥马利（《绿山墙的安妮》作者）的逝世日期，并推测其真实形象。尽管作者为新书而来，仍被她极具感染力的好奇心吸引。"
    },
    {
      "label": "Paragraph 8",
      "text": "作家戴维・希尔（David Hill）曾讲述趣事 —— 尽管他的写作风格与马希不同，但受马希 “独特的世界观” 影响，尤其欣赏她对 “语言鲜活变化” 的敏感度。希尔在 motel 看到门上标语 “此门装有警报”，认为马希会欣赏其中的潜在幽默，联想到 “窗户担忧、灯具恼怒” 等文字游戏，这一故事完美诠释了马希的视角。"
    }
  ],
  "questionExplanations": [
    ...
    {
      "sectionTitle": "2. 摘要填空（Questions 32–35：Choose A–I）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 32,
    ...
    },
    {
      ...
      "text": "答案：B（It was restructured in the writing process. 创作过程中进行了重构）\n解析：定位 Paragraph 3 中 “The story ballooned at one point to 800 pages and has been through at least two substantial rewrites. Now half its original size”，“大幅重写、篇幅减半” 对应 “restructured”，因此选 B。A（部分基于真实历史）、C（与传统故事完全不同）、D（未体现马希常见主题）均与原文矛盾。\n答案：C（is an old favourite for many families. 是许多家庭长期喜爱的作品）\n解析：定位 Paragraph 4 中 “Bubble Trouble is the Mahy that New Zealand children and their parents know so well... recited by Mahy at countless private and public functions”，“家庭熟悉、多次朗诵” 对应 “old favourite for many families”，因此选 C。A（1991 年首次插图出版）、B（语言朴素）、D（马希从未朗诵过）均与原文矛盾。\n答案：D（illustrate Mahy’s popularity with generations of children. 说明马希的作品受跨世代儿童欢迎）\n解析：Paragraph 5 列举 “作者本人、继女、子女、孙辈” 不同世代阅读马希作品的例子，核心是 “跨世代受欢迎”，因此选 D。A（展示马希风格的跨世代变化）、B（批评作品重复）、C（描述新媒体改变娱乐）均偏离目的。\n答案：C（Readers are necessary in order to complete a book. 读者是完成一本书的必要条件）\n解析：定位 Paragraph 6 中 “a book is not properly finished, she has often said, until it has been read, because a reader brings something important to the book”，“书在被阅读前不算完成” 对应 “readers are necessary to complete a book”，因此选 C。A（读者有时未读完马希的书）、B（马希积极鼓励读者反馈）、D（马希未意识到自己对部分读者的重要性）均未提及。\n答案：A（illustrating Mahy’s view of the world. 诠释马希的世界观）\n解析：定位 Paragraph 8 中 “His story was a wonderful comment on Mahy’s vision”，“戴维・希尔的故事诠释了马希的视角（vision）”，对应 “view of the world”，因此选 A。B（比较马希与另一位作家）、C（纠正对马希的误解）、D（解释马希创作方法的原因）均偏离目的。"
    }
  ]
}
  );
