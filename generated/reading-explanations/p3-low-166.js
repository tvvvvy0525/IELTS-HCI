(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "Paragraph 1",
      "text": "尽管载人火星任务计划推进，但质疑者提出 “为何前往火星”—— 火星荒芜、大气稀薄、气候严寒，且距离遥远。然而，火星可能是人类长期生存的关键：地球人口超 70 亿且持续增长，人类可能被迫寻找太阳系其他宜居地，火星或许比照片显示的更具潜力。"
    },
    {
      "label": "Paragraph 2",
      "text": "如今火星寒冷干燥，但与地球有相似之处：自转周期（火星 24 小时 37 分 vs 地球 23 小时 56 分）、轴倾角（火星 24° vs 地球 23.5°）、重力（火星为地球 1/3），且拥有支撑生命的元素（二氧化碳形式的碳氧、氮、极地冰盖的冻结水）。数十亿年前，地球大气与如今火星有显著相似性 —— 当时地球也无生命，大气全由二氧化碳和氮构成，直到光合细菌产生氧气，才孕育动植物。"
    },
    {
      "label": "Paragraph 3",
      "text": "因此，部分科学家认为 “地球大气从二氧化碳转为可呼吸空气” 的过程可在火星重演（通过技术而非自然进化），这一过程称为 “地球化改造（terraforming）”。初期将制造温室效应加热火星，进而创造动植物生存所需条件，但该过程极具挑战，可能需数千年才能将火星改造为类地环境。"
    },
    {
      "label": "Paragraph 4",
      "text": "已提出三种地球化方法，第一种技术已在开发（用途不同）：NASA 正研发 “大型镜面捕获太阳辐射” 的航天器推进系统，稍作修改即可用类似镜面反射阳光加热火星表面（20 万英里外聚焦镜面可使表面升温，集中照射极地冰盖可融化冰层、释放被困二氧化碳，逐步引发火星温室效应，为生命生存奠定基础）。"
    },
    {
      "label": "Paragraph 5",
      "text": "第二种方法是建立 “温室气体工厂”：工业产生的温室气体导致地球升温，火星上建造数百座排放温室气体的工厂可产生类似效果，工厂将二氧化碳、甲烷等泵入火星大气，同时模仿植物光合作用产氧（吸入二氧化碳、释放氧气），还可通过 “播种光合细菌” 加速产氧，最终人类需借助类似登山者的设备呼吸。"
    },
    {
      "label": "Paragraph 6",
      "text": "第三种（最极端）方法由太空科学家罗伯特・祖布林（Robert Zubrin）和克里斯托弗・麦凯（Christopher McKay）提出：发射含氨小行星撞击火星，每颗小行星重约 100 亿吨，由巨型火箭驱动（时速超 1 万英里），需十年抵达。撞击产生的能量可使火星升温 3℃，融化 1 万亿吨极地冰；他们认为需多颗小行星和至少 50 年，才能形成温带气候和覆盖 1/4 火星表面的水。"
    },
    {
      "label": "Paragraph 7",
      "text": "火星地球化改造成本高、难度大、耗时久（乐观者认为需 50-60 年，实际可能需数百年甚至数千年），将考验人类创造力和决心，但这一挑战或许能拯救人类。"
    }
  ],
  "questionExplanations": [
    ...
    {
      "sectionTitle": "2. 单选题（Questions 32–35：Choose A–D）",
      "mode": "per_question",
      "items": [
        {
          "questionNumber": 32,
      ...
      "text": "答案：D（It has some similarities with Earth. 与地球有相似之处）\n解析：定位 Paragraph 2 中 “it does have some things in common with our own planet. For example, it has a daily rotation rate... axial tilt... gravitational pull... holds many of the elements that are required to support life”，明确提到 “与地球的相似性” 是积极因素，因此选 D。\n答案：A（make the planet warmer. 使火星升温）\n解析：定位 Paragraph 3 中 “Terraforming... would initially create a greenhouse effect that would heat the planet, which in turn would create other conditions necessary to provide a suitable living environment for plants and animals”，“初期制造温室效应加热火星” 是第一步，因此选 A。\n答案：C（produce oxygen in a manner similar to plants. 以类似植物的方式产氧）\n解析：定位 Paragraph 5 中 “The same factories would then produce oxygen by mimicking the natural process of plant photosynthesis”，“模仿植物光合作用产氧” 对应 “类似植物的方式产氧”，因此选 C。\n答案：C（To consider how and why Mars might be terraformed. 探讨火星为何及如何进行地球化改造）\n解析：全文先说明 “火星地球化的必要性（人类生存）”，再详细介绍三种改造方法，A “仅说明原因”、B “仅说明步骤”、D “证明改造简单” 均片面，因此选 C。"
    },
    {
